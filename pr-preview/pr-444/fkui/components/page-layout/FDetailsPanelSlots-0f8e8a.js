...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-0f8e8a.js
...
exampleComponent.__scopeId = "data-v-0f8e8a";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0f8e8a"
});
export {
  render
};
