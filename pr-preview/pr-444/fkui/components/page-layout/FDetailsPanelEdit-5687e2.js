...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-5687e2.js
...
exampleComponent.__scopeId = "data-v-5687e2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-5687e2"
});
export {
  render
};
