...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-0664e2.js
...
exampleComponent.__scopeId = "data-v-0664e2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0664e2"
});
export {
  render
};
