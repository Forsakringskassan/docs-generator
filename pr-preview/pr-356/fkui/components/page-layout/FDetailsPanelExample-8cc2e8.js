...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-8cc2e8.js
...
exampleComponent.__scopeId = "data-v-8cc2e8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-8cc2e8"
});
export {
  render
};
