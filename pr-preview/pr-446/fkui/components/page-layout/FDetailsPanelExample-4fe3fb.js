...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-4fe3fb.js
...
exampleComponent.__scopeId = "data-v-4fe3fb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4fe3fb"
});
export {
  render
};
