...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-1686ba.js
...
exampleComponent.__scopeId = "data-v-1686ba";
setup({
  rootComponent: exampleComponent,
  selector: "#example-1686ba"
});
export {
  render
};
