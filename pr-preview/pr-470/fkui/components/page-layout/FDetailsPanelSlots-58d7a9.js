...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-58d7a9.js
...
exampleComponent.__scopeId = "data-v-58d7a9";
setup({
  rootComponent: exampleComponent,
  selector: "#example-58d7a9"
});
export {
  render
};
