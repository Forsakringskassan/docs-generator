...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-2e5ccd.js
...
exampleComponent.__scopeId = "data-v-2e5ccd";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2e5ccd"
});
export {
  render
};
