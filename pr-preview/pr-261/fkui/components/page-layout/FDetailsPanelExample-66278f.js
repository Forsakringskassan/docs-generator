...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-66278f.js
...
exampleComponent.__scopeId = "data-v-66278f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-66278f"
});
export {
  render
};
