...
function _sfc_render$U(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, {
    ...
    footer: withCtx(() => [createElementVNode("div", _hoisted_1$P, [!_ctx.hasDeprecatedSlots ? (openBlock(true), createElementBlock(Fragment, {
      ...
      }, [createElementVNode("span", null, toDisplayString(button.label), 1), _cache[3] || (_cache[3] = createTextVNode()), button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$t, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)], 10, _hoisted_2$A);
  ...
  return openBlock(), createBlock(_component_i_popup, {
    ...
    default: withCtx(() => [createElementVNode("nav", {
      ...
      return openBlock(), createElementBlock("li", {
        ...
        target: item.target,
        tabindex: "0"
      }, [_ctx.isSelected(index) ? (openBlock(), createElementBlock("span", _hoisted_5$g, [createElementVNode("span", null, toDisplayString(_ctx.selectedMenuItemScreenReaderText) + "\xA0", 1)])) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(item.label), 1)], 8, _hoisted_4$l)], 10, _hoisted_3$p);
    }), 128))])], 8, _hoisted_1$F)]),
    _: 1
...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [(openBlock(), createBlock(Teleport, {
    ...
    _: 3
  })) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), createElementVNode("div", _hoisted_5$f, [renderSlot(_ctx.$slots, "body")]), _cache[6] || (_cache[6] = createTextVNode()), createElementVNode("div", _hoisted_6$d, [createElementVNode("button", {
    class: "close-button",
    type: "button",
  ...
  methods: {
    ...
    onFormModalSubmit() {
      ...
      if (this.operation === Operation.ADD) {
        ...
        this.$emit("update:modelValue", this.result);
        this.$emit("change", this.result);
        alertScreenReader(this.$t("fkui.crud-dataset.aria-live.modify", "Raden har \xE4ndrats"), {
          assertive: true
        });
      }
      this.isFormModalOpen = false;
...
function _sfc_render$B(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$z, [renderSlot(_ctx.$slots, "default"), _cache[7] || (_cache[7] = createTextVNode()), _ctx.hasAddSlot ? (openBlock(), createElementBlock("div", _hoisted_2$r, [createElementVNode("button", {
    ...
    class: "button__icon",
    name: "plus"
  }), _cache[1] || (_cache[1] = createTextVNode()), renderSlot(_ctx.$slots, "add-button", {}, () => [createTextVNode(toDisplayString(_ctx.$t("fkui.crud-dataset.button.add", "L\xE4gg till ny")), 1)])])])) : createCommentVNode("", true), _cache[8] || (_cache[8] = createTextVNode()), createVNode(_component_f_form_modal, {
...
function _sfc_render$y(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return _ctx.$slots.tooltip ? (openBlock(), createElementBlock("div", _hoisted_1$x, [_ctx.hasDefaultSlot ? (openBlock(), createElementBlock("div", _hoisted_2$q, [createElementVNode("label", {
    class: "label",
...
function _sfc_render$s(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_i_flex = resolveComponent("i-flex");
  return openBlock(), createElementBlock("div", _hoisted_1$s, [createVNode(_component_i_flex, {
    collapse: "",
    gap: "3x",
    wrap: ""
  }, {
    default: withCtx(() => [createVNode(_component_i_flex_item, {
      ...
      default: withCtx(() => [createVNode(_component_i_flex, {
        ...
        default: withCtx(() => [_ctx.showFilter ? (openBlock(), createBlock(_component_i_flex_item, {
          ...
          default: withCtx(() => [createElementVNode("div", _hoisted_2$o, [createVNode(_component_f_icon, {
            name: "search",
            ...
            default: withCtx(() => [createElementVNode("span", _hoisted_3$j, toDisplayString(_ctx.placeholderFilter), 1)]),
            _: 1
            ...
            name: "close"
          }), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("span", _hoisted_5$b, toDisplayString(_ctx.$t("fkui.sort-filter-dataset.clear.filter", "Rensa s\xF6kf\xE4lt")), 1)], 8, _hoisted_4$f)) : createCommentVNode("", true)])]),
          _: 1
          ...
          default: withCtx(() => [createVNode(_component_f_select_field, {
            ...
            label: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("fkui.sort-filter-dataset.label.sort", "Sortera\xA0p\xE5")), 1)]),
            default: withCtx(() => [_cache[6] || (_cache[6] = createTextVNode()), createElementVNode("option", _hoisted_6$9, toDisplayString(_ctx.$t("fkui.sort-filter-dataset.label.unsorted", "V\xE4lj")), 1), _cache[7] || (_cache[7] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.sortOrders, (sortOrder) => {
...
function _sfc_render$r(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
  ...
  }, _ctx.$attrs), [_ctx.hasCaption ? (openBlock(), createElementBlock("caption", _hoisted_2$n, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("", true), _cache[4] || (_cache[4] = createTextVNode()), createElementVNode("colgroup", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.columns, (column) => {
    return openBlock(), createElementBlock("col", {
      key: column.id,
      class: normalizeClass(column.size)
    }, null, 2);
  }), 128))]), _cache[5] || (_cache[5] = createTextVNode()), createElementVNode("thead", null, [createElementVNode("tr", _hoisted_3$i, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.visibleColumns, (column) => {
    ...
    }, null, 8, _hoisted_4$e), _cache[0] || (_cache[0] = createTextVNode()), column.sortable ? (openBlock(), createBlock(_component_f_icon, {
      key: 0,
  ...
  }, [renderSlot(_ctx.$slots, "empty", {}, () => [createTextVNode(toDisplayString(_ctx.$t("fkui.data-table.empty", "Tabellen \xE4r tom")), 1)])], 8, _hoisted_8$6)])) : createCommentVNode("", true), _cache[3] || (_cache[3] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.rows, (row) => {
    return openBlock(), createElementBlock("tr", {
      key: _ctx.rowKey(row),
      class: "table__row"
...
function _sfc_render$p(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    default: withCtx(() => [createElementVNode("button", mergeProps({
    ...
    }), [createElementVNode("span", _hoisted_2$l, [createElementVNode("span", _hoisted_3$g, [createVNode(_component_f_icon, {
      name: "dash"
      ...
      name: "bell"
    })], 8, _hoisted_4$c)) : createCommentVNode("", true)], 16, _hoisted_1$p)]),
    _: 3
...
function _sfc_render$o(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    default: withCtx(() => [createElementVNode("button", mergeProps({
      ...
      name: "dash"
    })])]), _cache[2] || (_cache[2] = createTextVNode()), renderSlot(_ctx.$slots, "title")], 16, _hoisted_1$o)]),
    _: 3
...
function _sfc_render$n(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$n, [createElementVNode("div", _hoisted_2$j, [createElementVNode("a", mergeProps({
    id: _ctx.id,
    ...
    name: _ctx.iconName
  }, null, 8, ["name"])]), _cache[1] || (_cache[1] = createTextVNode()), createElementVNode("span", _hoisted_5$7, toDisplayString(_ctx.fileName), 1), _cache[2] || (_cache[2] = createTextVNode()), createElementVNode("span", _hoisted_6$5, "\xA0" + toDisplayString(_ctx.$t("fkui.file-item.file-open", "\xF6ppnas i nytt f\xF6nster")), 1)], 16, _hoisted_3$e), _cache[3] || (_cache[3] = createTextVNode()), renderSlot(_ctx.$slots, "row")]), _cache[4] || (_cache[4] = createTextVNode()), renderSlot(_ctx.$slots, "default"), _cache[5] || (_cache[5] = createTextVNode()), _ctx.isMimeTypeChanged ? (openBlock(), createElementBlock("div", _hoisted_7$5, toDisplayString(_ctx.mimeTypeChangedText), 1)) : createCommentVNode("", true), _cache[6] || (_cache[6] = createTextVNode()), _cache[7] || (_cache[7] = createElementVNode("hr", {
...
function _sfc_render$m(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$m, [createElementVNode("input", mergeProps({
    id: _ctx.id,
    ref: "file-selector",
    type: "file",
    ...
    class: "button__icon",
    name: "paper-clip"
  }), _cache[1] || (_cache[1] = createTextVNode()), renderSlot(_ctx.$slots, "default")], 10, _hoisted_3$d)]);
}
...
function _sfc_render$l(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [_ctx.provideScreenReaderContext ? (openBlock(), createElementBlock("span", _hoisted_1$l, toDisplayString(_ctx.screenReaderContext()), 1)) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), createVNode(_component_i_flex, {
    gap: "2x"
  }, {
...
function _sfc_render$k(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("form", mergeProps({
    ...
    _: 3
  })) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), renderSlot(_ctx.$slots, "default")], 16, _hoisted_1$k);
}
...
function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_validation_group, mergeProps({
    ...
    default: withCtx(() => [createElementVNode("div", _hoisted_1$j, [renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({
      ...
      _: 3
    }, 8, ["items", "before-navigate"])])], 8, _hoisted_2$h)) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), createElementVNode("div", {
      onComponentValidity: _cache[0] || (_cache[0] = (...args) => _ctx.onComponentValidity && _ctx.onComponentValidity(...args))
    }, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
      ..._ctx.self.ref,
      isSubmitted: _ctx.isSubmitted,
      toggleIsOpen: _ctx.toggleIsOpen
    }))), _cache[3] || (_cache[3] = createTextVNode()), _ctx.hasArrow ? (openBlock(), createElementBlock("span", _hoisted_3$c)) : createCommentVNode("", true)], 32)]),
    _: 3
  }, 16, ["id", "modelValue"]);
}
...
function _sfc_render$i(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("button", mergeProps({
    ...
    name: "pen",
    class: "button__icon"
  }), createTextVNode(" " + toDisplayString(_ctx.isAnyFieldTouched ? _ctx.$t("fkui.form-step-button.edit", "\xC4ndra") : _ctx.$t("fkui.form-step-button.open", "Fyll i")), 1)], 64)), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("span", _hoisted_2$g, toDisplayString(_ctx.additionalScreenreaderText), 1)], 16, _hoisted_1$i);
}
...
var _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$h, [hasHeaderSlot.value ? (openBlock(), createElementBlock("div", _hoisted_2$f, [renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({
        headingSlotClass: "card__header-label"
      })))])) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("div", _hoisted_3$b, [renderSlot(_ctx.$slots, "default")]), _cache[1] || (_cache[1] = createTextVNode()), hasFooterSlot.value ? (openBlock(), createElementBlock("div", _hoisted_4$9, [renderSlot(_ctx.$slots, "footer")])) : createCommentVNode("", true)]);
    };
  }
});
var _sfc_main$h = defineComponent({
...
function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$g, [_ctx.showHeader || _ctx.showTopNavigation ? (openBlock(), createElementBlock("header", _hoisted_2$e, [_ctx.showHeader ? renderSlot(_ctx.$slots, "header", {
    key: 0
...
function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.selectable ? (openBlock(), createElementBlock("ul", _hoisted_1$d, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
  ...
  }), 128)), _cache[2] || (_cache[2] = createTextVNode()), _ctx.isEmpty ? (openBlock(), createElementBlock("li", _hoisted_2$b, [createElementVNode("div", _hoisted_3$8, [renderSlot(_ctx.$slots, "empty", {}, () => [createElementVNode("em", null, toDisplayString(_ctx.$t("fkui.list.empty", "Listan \xE4r tom")), 1)])])])) : createCommentVNode("", true)])) : (openBlock(), createElementBlock("ul", {
    key: 1,
    ref: "ulElement",
    ...
    return openBlock(), createElementBlock("li", {
    ...
    }, [createElementVNode("div", _hoisted_7$4, [createVNode(_component_f_checkbox_field, {
      value: true,
      ...
      _: 2
    }, 1032, ["model-value", "onClick"])])], 8, _hoisted_6$4)) : createCommentVNode("", true), _cache[3] || (_cache[3] = createTextVNode()), (openBlock(), createBlock(resolveDynamicComponent(_ctx.checkbox ? "div" : "a"), {
      ref_for: true,
      ref: "listItemPanes",
  ...
  }), 128)), _cache[4] || (_cache[4] = createTextVNode()), _ctx.isEmpty ? (openBlock(), createElementBlock("li", _hoisted_9$3, [createElementVNode("div", _hoisted_10$2, [renderSlot(_ctx.$slots, "empty", {}, () => [createElementVNode("em", null, toDisplayString(_ctx.$t("fkui.list.empty", "Listan \xE4r tom")), 1)])])])) : createCommentVNode("", true)], 8, _hoisted_4$6));
}
...
function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createElementVNode("div", _hoisted_7$3, [createElementVNode("a", {
    ref: "popup-anchor",
    tabindex: "0",
    class: "imenu__list__anchor",
    role: "menuitem",
  ...
  })], 8, _hoisted_8$3)])], 2)])) : createCommentVNode("", true)], 32), _cache[7] || (_cache[7] = createTextVNode()), createVNode(_component_i_popup_menu, {
    ref: "popup-menu",
...
function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$8, [_ctx.skipLinkAnchor ? (openBlock(), createElementBlock("nav", _hoisted_2$6, [createVNode(_component_i_skip_link, {
    ...
    _: 3
  }, 8, ["href"])])) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), createElementVNode("div", _hoisted_3$5, [createElementVNode("div", _hoisted_4$3, [renderSlot(_ctx.$slots, "logo", {}, () => [_ctx.routerLinkTo ? (openBlock(), createBlock(_component_router_link, {
    key: 0,
    ...
    "aria-label": _ctx.altLogoText,
    role: "img"
  }, null, 10, _hoisted_6$2))])]), _cache[0] || (_cache[0] = createTextVNode()), (openBlock(), createBlock(resolveDynamicComponent(_ctx.headerTag), {
    class: "page-header__app-name"
  }, {
    default: withCtx(() => [renderSlot(_ctx.$slots, "default")]),
    _: 3
  })), _cache[1] || (_cache[1] = createTextVNode()), createElementVNode("div", _hoisted_7$2, [createElementVNode("div", _hoisted_8$2, [renderSlot(_ctx.$slots, "right")])])], 512)]);
}
...
function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createElementVNode("span", _hoisted_3$4, toDisplayString(_ctx.progressText), 1)], 14, _hoisted_2$5)]);
}
...
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    key: 0
  }, [_ctx.showDetails === "always" ? (openBlock(), createElementBlock("span", _hoisted_3$3, [_cache[1] || (_cache[1] = createElementVNode("br", null, null, -1)), _cache[2] || (_cache[2] = createTextVNode()), renderSlot(_ctx.$slots, "details")])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), _ctx.showDetails === "when-selected" ? (openBlock(), createBlock(Transition, {
    key: 1,
    onEnter: _ctx.enter,
    onAfterEnter: _ctx.afterEnter,
    onLeave: _ctx.leave
...
function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_label = resolveComponent("f-label");
  return openBlock(), createElementBlock("div", _hoisted_1$5, [createVNode(_component_f_label, null, createSlots({
    default: withCtx(() => [renderSlot(_ctx.$slots, "label")]),
    description: withCtx(({
      descriptionClass,
      discreteDescriptionClass
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    class: ["table", _ctx.tableClasses],
    role: _ctx.tableRole
  }, _ctx.$attrs), [_ctx.hasCaption ? (openBlock(), createElementBlock("caption", _hoisted_2$2, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("", true), _cache[14] || (_cache[14] = createTextVNode()), createElementVNode("colgroup", null, [_ctx.isExpandableTable ? (openBlock(), createElementBlock("col", _hoisted_3$2)) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), _ctx.selectable ? (openBlock(), createElementBlock("col", _hoisted_4$1)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.columns, (column) => {
    return openBlock(), createElementBlock("col", {
      key: column.id,
      class: normalizeClass(column.size)
    }, null, 2);
  }), 128))]), _cache[15] || (_cache[15] = createTextVNode()), createElementVNode("thead", null, [createElementVNode("tr", _hoisted_5$1, [_ctx.isExpandableTable ? (openBlock(), createElementBlock("th", _hoisted_6$1, [createElementVNode("span", _hoisted_7$1, toDisplayString(_ctx.$t("fkui.interactive-table.select", "Expandera")), 1)])) : createCommentVNode("", true), _cache[4] || (_cache[4] = createTextVNode()), _ctx.selectable ? (openBlock(), createElementBlock("th", _hoisted_8$1, [createElementVNode("span", _hoisted_9$1, toDisplayString(_ctx.$t("fkui.interactive-table.select", "Markera")), 1)])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.visibleColumns, (column) => {
    return openBlock(), createElementBlock("th", mergeProps({
      key: column.id,
      scope: "col",
      class: _ctx.columnClasses(column)
      ...
      innerHTML: _ctx.escapeNewlines(column.title)
    }, null, 8, _hoisted_10$1), _cache[2] || (_cache[2] = createTextVNode()), column.sortable ? (openBlock(), createBlock(_component_f_icon, {
      key: 0,
      class: normalizeClass(_ctx.iconClasses(column)),
      name: _ctx.iconName(column)
  ...
  }, [renderSlot(_ctx.$slots, "empty", {}, () => [createTextVNode(toDisplayString(_ctx.$t("fkui.interactive-table.empty", "Tabellen \xE4r tom")), 1)])], 8, _hoisted_23)])) : createCommentVNode("", true)], 512)], 16, _hoisted_1$4)], 2);
}
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createElementVNode("div", _hoisted_2$1, [createVNode(_component_i_flex, null, {
    default: withCtx(() => [createVNode(_component_i_flex_item, {
      align: "bottom",
      shrink: "",
      "aria-hidden": "true"
      ...
      }, null, -1)), _cache[6] || (_cache[6] = createTextVNode()), createElementVNode("div", _hoisted_3$1, [createVNode(_component_f_icon, {
        name: "circle"
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1, [_ctx.options.length > 0 ? (openBlock(), createElementBlock("ul", _hoisted_2, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.options, (option, index) => {
    return openBlock(), createElementBlock("li", {
      key: option.label,
