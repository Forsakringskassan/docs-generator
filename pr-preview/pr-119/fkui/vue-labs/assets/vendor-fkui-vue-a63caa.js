...
import { defineComponent, openBlock, createElementBlock, normalizeClass, renderSlot, mergeProps, createTextVNode, createElementVNode, isVNode, Comment, createApp, resolveComponent, withKeys, createCommentVNode, toDisplayString, createVNode, createBlock, withCtx, Fragment, renderList, withModifiers, resolveDynamicComponent, Teleport, normalizeProps, guardReactiveProps, ref, inject, useSlots, provide, toValue, Transition, createSlots, withDirectives, vModelSelect, normalizeStyle, vModelDynamic, computed, toHandlers, shallowRef, vShow, onMounted, onUnmounted, watchEffect, toRefs, getCurrentInstance } from "vue";
...
var _sfc_main$1d = defineComponent({ name: "FBadge", props: {
  /**
...
function _sfc_render$13(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    { class: normalizeClass(["badge", _ctx.badgeClass]) },
...
var _sfc_main$1c = defineComponent({ name: "FIcon", inheritAttrs: false, props: {
  /**
  * Icon name.
  */
...
function _sfc_render$12(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps(_ctx.$attrs, { focusable: "false", class: ["icon", [_ctx.spriteKey, ..._ctx.modifiers]], "aria-hidden": _ctx.ariaHidden }), [renderSlot(_ctx.$slots, "default"), createTextVNode(), createElementVNode("use", { "xlink:href": _ctx.spriteId }, null, 8, _hoisted_2$G)], 16, _hoisted_1$U);
}
...
var _sfc_main$1b = defineComponent({ name: "FModal", components: { FIcon }, mixins: [TranslationMixin], inheritAttrs: true, props: {
  /**
...
function _sfc_render$11(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _ctx.isOpen ? (openBlock(), createElementBlock("div", { key: 0, id: _ctx.id, class: normalizeClass(["modal", _ctx.modalClass]) }, [createElementVNode("div", _hoisted_2$F, [createElementVNode(
    "div",
    ...
    [createElementVNode("div", _hoisted_3$z, [createElementVNode(
      "div",
      { ref: "modalDialogContainer", class: normalizeClass(["modal__dialog-container", _ctx.containerClasses]) },
      [createElementVNode("div", _hoisted_4$t, [createElementVNode("div", _hoisted_5$p, [createElementVNode("div", _hoisted_6$k, [createElementVNode(
        "div",
        ...
        512
        /* NEED_PATCH */
      )) : createCommentVNode("v-if", true)]), createTextVNode(), createElementVNode(
        "div",
        _hoisted_8$b,
        [renderSlot(_ctx.$slots, "content")],
        512
        /* NEED_PATCH */
      ), createTextVNode(), createElementVNode("div", _hoisted_9$7, [renderSlot(_ctx.$slots, "footer")])]), createTextVNode(), createElementVNode("div", _hoisted_10$7, [createElementVNode("button", { type: "button", class: "close-button", "aria-label": _ctx.ariaCloseText, onClick: _cache[1] || (_cache[1] = (...args) => _ctx.onClose && _ctx.onClose(...args)) }, [createElementVNode(
        "span",
        null,
        toDisplayString(_ctx.$t("fkui.modal.close", "St\xE4ng")),
        1
        /* TEXT */
      ), createTextVNode(), createVNode(_component_f_icon, { name: "close" })], 8, _hoisted_11$3), createTextVNode(), createElementVNode(
        "div",
...
var _sfc_main$1a = defineComponent({ name: "FConfirmModal", components: { FModal }, inheritAttrs: true, props: {
  /**
  * Enable fullscreen mode in mobile.
  */
  fullscreen: { type: Boolean, required: false, default: false },
...
function _sfc_render$10(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, { fullscreen: _ctx.fullscreen, "is-open": _ctx.isOpen, "aria-close-text": _ctx.ariaCloseText, type: "warning", size: _ctx.size, onClose: _ctx.onClose }, {
    ...
    footer: withCtx(() => [createElementVNode("div", _hoisted_1$S, [(openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.preparedButtons, (button) => {
        return openBlock(), createElementBlock("button", { key: button.label, type: "button", class: normalizeClass([button.classlist, "button-group__item"]), onClick: ($event) => _ctx.onClick(button) }, [createElementVNode(
          "span",
          null,
          ...
          "span",
          _hoisted_3$y,
          "\xA0" + toDisplayString(button.screenreader),
          1
          /* TEXT */
...
var _sfc_main$19 = defineComponent({ name: "IFlex", inheritAttrs: true, props: {
  /**
...
var _sfc_main$18 = defineComponent({ name: "IFlexItem", inheritAttrs: true, props: {
  /**
...
var _sfc_main$17 = defineComponent({ name: "FErrorList", components: { FIcon, IFlex, IFlexItem }, props: {
  /**
...
var _hoisted_5$o = /* @__PURE__ */ createElementVNode(
  "span",
...
var _hoisted_7$f = /* @__PURE__ */ createElementVNode(
  "span",
  { class: "error-list__bullet", "aria-hidden": "true" },
  null,
  -1
...
function _sfc_render$Z(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$R, [createVNode(_component_i_flex, null, {
    default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createBlock(_component_i_flex_item, { key: 0, shrink: "" }, {
      ...
      default: withCtx(() => [createTextVNode("\xA0")]),
      _: 1
      /* STABLE */
    })) : createCommentVNode("v-if", true), createTextVNode(), createVNode(_component_i_flex_item, { grow: "" }, {
      default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createElementBlock("div", _hoisted_2$D, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode("ul", _hoisted_3$x, [(openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList(_ctx.items, (item) => {
          return openBlock(), createElementBlock(
            ...
            [item.id ? (openBlock(), createElementBlock("a", { key: 0, href: "javascript:", onClick: withModifiers(($event) => _ctx.onClickItem(item), ["prevent"]) }, [_ctx.bullets ? (openBlock(), createElementBlock(
              Fragment,
              { key: 0 },
              [_hoisted_5$o, createTextVNode(), createElementVNode(
                "span",
                _hoisted_6$j,
              ...
              [_ctx.bullets ? (openBlock(), createElementBlock(
                Fragment,
                { key: 0 },
                [_hoisted_7$f, createTextVNode(), createElementVNode(
                  "span",
                  null,
                  toDisplayString(item.title),
                  1
...
var _sfc_main$16 = defineComponent({ name: "FValidationGroup", props: {
  /**
...
var _sfc_main$15 = defineComponent({ name: "FValidationForm", components: { FValidationGroup, FErrorList }, inheritAttrs: false, props: {
  /**
...
function _sfc_render$X(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_validation_group, { key: _ctx.groupKey, modelValue: _ctx.validity, "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.validity = $event), "stop-propagation": true }, {
    default: withCtx(() => [createElementVNode("form", mergeProps({ id: _ctx.id }, _ctx.$attrs, { novalidate: "", autocomplete: "off", onSubmit: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.onSubmit && _ctx.onSubmit(...args), ["prevent"])) }), [_ctx.displayErrors ? (openBlock(), createElementBlock(
      "nav",
      _hoisted_2$C,
...
var _sfc_main$14 = defineComponent({ name: "FFormModal", components: { FModal, FValidationForm }, mixins: [TranslationMixin], inheritAttrs: true, props: {
  /**
  * Enable fullscreen mode in mobile.
  */
...
function _sfc_render$W(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, { "data-test": _ctx.dataTest, fullscreen: _ctx.fullscreen, "is-open": _ctx.isOpen, size: _ctx.size, "aria-close-text": _ctx.ariaCloseText, onClose: _ctx.onClose }, {
    ...
    content: withCtx(() => [createElementVNode("div", null, [renderSlot(_ctx.$slots, "default")]), createTextVNode(), createVNode(_component_f_validation_form, { id: _ctx.formId, "before-submit": _ctx.beforeSubmit, "before-validation": _ctx.beforeValidation, "use-error-list": _ctx.useErrorList, onSubmit: _ctx.onSubmit, onCancel: _ctx.onCancel }, {
    ...
    footer: withCtx(() => [createElementVNode("div", _hoisted_1$P, [!_ctx.hasDeprecatedSlots ? (openBlock(true), createElementBlock(
      ...
      { key: 0 },
      renderList(_ctx.preparedButtons, (button) => {
        return openBlock(), createElementBlock("button", { key: button.label, type: button.buttonType, class: normalizeClass([button.classlist, "button-group__item"]), form: button.buttonType === "submit" ? _ctx.formId : void 0, onClick: ($event) => button.buttonType === "button" ? _ctx.onCancel() : false }, [createElementVNode(
          "span",
          null,
          toDisplayString(button.label),
          1
      ...
      Fragment,
      { key: 1 },
      [createElementVNode("button", { form: _ctx.formId, "data-test": "submit-button", type: "submit", class: "button button--primary button-group__item button--large" }, [renderSlot(_ctx.$slots, "submit-button-text", {}, () => [createTextVNode(
        toDisplayString(_ctx.$t("fkui.form-modal.button.submit.text", "Spara")),
        1
        /* TEXT */
      )])], 8, _hoisted_4$r), createTextVNode(), createElementVNode("button", { "data-test": "cancel-button", type: "button", class: "button button--secondary button-group__item button--large", onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onCancel && _ctx.onCancel(...args)) }, [renderSlot(_ctx.$slots, "cancel-button-text", {}, () => [createTextVNode(
...
var _sfc_main$13 = defineComponent({ name: "FErrorPage", props: { payload: { type: Object, required: false, default: null } } });
var _hoisted_1$O = { "data-test": "f-error-page" };
var _hoisted_2$A = /* @__PURE__ */ createElementVNode(
  "h1",
  null,
  "Fel",
  -1
...
var _hoisted_3$v = /* @__PURE__ */ createElementVNode(
  "p",
  null,
...
var _hoisted_4$q = /* @__PURE__ */ createElementVNode(
  "a",
  { href: "/" },
...
function _sfc_render$V(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$O, [_hoisted_2$A, createTextVNode(), _hoisted_3$v, createTextVNode(), _hoisted_4$q]);
}
var FErrorPage = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["render", _sfc_render$V]]);
var _sfc_main$12 = defineComponent({ name: "FErrorHandlingApp", props: { defaultComponent: { type: [Function, Object], required: false, default: void 0 }, errorComponent: { type: [Function, Object], required: false, default: FErrorPage } }, data() {
...
function _sfc_render$U(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [_ctx.hasError ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.errorComponent), { key: 0, payload: _ctx.payload }, null, 8, ["payload"])) : _ctx.defaultComponent ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.defaultComponent), { key: 1 })) : renderSlot(_ctx.$slots, "default", { key: 2 })]);
}
...
var _sfc_main$11 = defineComponent({ name: "ICalendarNavbar", components: { FIcon }, mixins: [TranslationMixin], props: {
  /**
  * Focused month.
  */
...
function _sfc_render$T(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$N, [createElementVNode(
    "div",
    _hoisted_2$z,
    toDisplayString(_ctx.currentText),
    1
    /* TEXT */
  ), createTextVNode(), createElementVNode("button", { ref: "previousButton", class: "calendar-navbar__arrow calendar-navbar__arrow--previous", type: "button", "aria-disabled": _ctx.previousDisabled, "aria-live": _ctx.isFocused("previousButton") ? "polite" : "off", onClick: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.onClickPreviousButton && _ctx.onClickPreviousButton(...args), ["stop"])) }, [createElementVNode(
    "span",
    _hoisted_4$p,
    toDisplayString(_ctx.previousSrText),
    1
    /* TEXT */
  ), createTextVNode(), createVNode(_component_f_icon, { class: normalizeClass(_ctx.previousIconClasses), name: "arrow-right" }, null, 8, ["class"])], 8, _hoisted_3$u), createTextVNode(), createElementVNode("button", { ref: "nextButton", class: "calendar-navbar__arrow calendar-navbar__arrow--next", type: "button", "aria-disabled": _ctx.nextDisabled, "aria-live": _ctx.isFocused("nextButton") ? "polite" : "off", onClick: _cache[1] || (_cache[1] = withModifiers((...args) => _ctx.onClickNextButton && _ctx.onClickNextButton(...args), ["stop"])) }, [createElementVNode(
    "span",
    _hoisted_6$i,
    toDisplayString(_ctx.nextSrText),
    1
    /* TEXT */
  ), createTextVNode(), createVNode(_component_f_icon, { class: normalizeClass(_ctx.nextIconClasses), name: "arrow-right" }, null, 8, ["class"])], 8, _hoisted_5$n)]);
}
...
var _sfc_main$10 = defineComponent({ name: "ICalendarMonthGrid", props: {
  /**
  * Focused month.
  * @model
  */
  ...
  */
  ...
  return { weekdays: getWeekdayNamings(), focused: false, resizeObserver: void 0, internalHideWeekNumbers: false, showShortWeekdays: false };
}, computed: { totalCols() {
...
var _hoisted_2$y = /* @__PURE__ */ createElementVNode(
  "col",
...
var _hoisted_3$t = /* @__PURE__ */ createElementVNode(
  "col",
  { class: "calendar-month__col--day" },
  null,
  -1
...
var _hoisted_4$o = /* @__PURE__ */ createElementVNode(
  "col",
  { class: "calendar-month__col--day" },
  null,
  -1
...
var _hoisted_5$m = /* @__PURE__ */ createElementVNode(
  "col",
  { class: "calendar-month__col--day" },
  null,
  -1
...
var _hoisted_6$h = /* @__PURE__ */ createElementVNode(
  "col",
  { class: "calendar-month__col--day" },
  null,
  -1
...
var _hoisted_7$e = /* @__PURE__ */ createElementVNode(
  "col",
  { class: "calendar-month__col--day" },
  null,
  -1
...
var _hoisted_8$a = /* @__PURE__ */ createElementVNode(
  "col",
  { class: "calendar-month__col--day" },
  null,
  -1
...
function _sfc_render$S(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    [createElementVNode("colgroup", null, [!_ctx.internalHideWeekNumbers ? (openBlock(), createElementBlock("col", _hoisted_1$M)) : createCommentVNode("v-if", true), createTextVNode(), _hoisted_2$y, createTextVNode(), _hoisted_3$t, createTextVNode(), _hoisted_4$o, createTextVNode(), _hoisted_5$m, createTextVNode(), _hoisted_6$h, createTextVNode(), _hoisted_7$e, createTextVNode(), _hoisted_8$a]), createTextVNode(), createElementVNode("thead", _hoisted_9$6, [createElementVNode("tr", _hoisted_10$6, [!_ctx.internalHideWeekNumbers ? (openBlock(), createElementBlock("th", _hoisted_11$2)) : createCommentVNode("v-if", true), createTextVNode(), (openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.weekdays, (weekday) => {
        return openBlock(), createElementBlock("th", { key: weekday.name, scope: "col", role: "presentation", class: "calendar-month__header-cell" }, [createElementVNode("abbr", { "aria-hidden": "true", title: weekday.name }, toDisplayString(_ctx.showShortWeekdays ? weekday.shortName : weekday.name), 9, _hoisted_12$2)]);
      }),
      128
      /* KEYED_FRAGMENT */
    ))])]), createTextVNode(), createElementVNode("tbody", _hoisted_13$2, [(openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.weeks, (week) => {
        return openBlock(), createElementBlock("tr", { key: week.week, role: "presentation" }, [!_ctx.internalHideWeekNumbers ? (openBlock(), createElementBlock(
          "td",
          _hoisted_14$2,
          toDisplayString(week.week),
          1
          /* TEXT */
        )) : createCommentVNode("v-if", true), createTextVNode(), _ctx.getDayStartOffset(week.days) ? (openBlock(), createElementBlock("td", { key: 1, class: "calendar-month__cell", colspan: _ctx.getDayStartOffset(week.days), "aria-hidden": "true" }, null, 8, _hoisted_15$2)) : createCommentVNode("v-if", true), createTextVNode(), (openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList(week.days, (day) => {
            return openBlock(), createElementBlock("td", { key: day.toString(), class: "calendar-month__cell", role: "presentation" }, [renderSlot(_ctx.$slots, "default", { date: day, focused: _ctx.focused })]);
          }),
          128
          /* KEYED_FRAGMENT */
        )), createTextVNode(), _ctx.getDayEndOffset(week.days) ? (openBlock(), createElementBlock("td", { key: 2, class: "calendar-month__cell", colspan: _ctx.getDayEndOffset(week.days), "aria-hidden": "true" }, null, 8, _hoisted_16$1)) : createCommentVNode("v-if", true)]);
      }),
      128
      /* KEYED_FRAGMENT */
    )), createTextVNode(), _ctx.weeks.length < 5 ? (openBlock(), createElementBlock("tr", _hoisted_17$1, [createElementVNode("td", { class: "calendar-month__cell", colspan: _ctx.totalCols, "aria-hidden": "true" }, null, 8, _hoisted_18$1)])) : createCommentVNode("v-if", true), createTextVNode(), _ctx.weeks.length < 6 ? (openBlock(), createElementBlock("tr", _hoisted_19$1, [createElementVNode("td", { class: "calendar-month__cell", colspan: _ctx.totalCols, "aria-hidden": "true" }, null, 8, _hoisted_20$1)])) : createCommentVNode("v-if", true)])],
    32
    /* NEED_HYDRATION */
  );
}
...
var _sfc_main$$ = defineComponent({ name: "ICalendarMonth", components: { ICalendarMonthGrid }, mixins: [TranslationMixin], props: {
  /**
  * Active month.
  * @model
  */
...
function _sfc_render$R(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_i_calendar_month_grid, { value: _ctx.modelValue }, {
    default: withCtx(({ date }) => [createElementVNode("button", { ref: date.toString(), class: "calendar-month__button", "data-test": "select-day-button", "data-date": date.toString(), tabindex: _ctx.getTabindex(date), type: "button", onClick: withModifiers(($event) => _ctx.onClickDay(date), ["stop", "prevent"]), onKeydown: ($event) => _ctx.onKeydownDay(date, $event) }, [renderSlot(_ctx.$slots, "default", { date, isFocused: _ctx.isDayFocused(date) })], 40, _hoisted_1$L)]),
    _: 3
    /* FORWARDED */
  }, 8, ["value"]);
}
var ICalendarMonth = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["render", _sfc_render$R]]);
var _sfc_main$_ = defineComponent({ name: "FCalendar", components: { ICalendarNavbar, ICalendarMonth }, props: {
  /**
  * Active month.
  * @model
  */
...
function _sfc_render$Q(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$K, [createVNode(_component_i_calendar_navbar, { "model-value": _ctx.modelValue, "min-date": _ctx.minDate, "max-date": _ctx.maxDate, "onUpdate:modelValue": _ctx.onChangeMonth }, null, 8, ["model-value", "min-date", "max-date", "onUpdate:modelValue"]), createTextVNode(), createVNode(_component_i_calendar_month, { "model-value": _ctx.modelValue, "min-date": _ctx.minDate, "max-date": _ctx.maxDate, "tab-date": _ctx.tabDate, onClick: _ctx.onClickDay, "onUpdate:modelValue": _ctx.onChangeMonth }, {
    default: withCtx(({ date, focused }) => [renderSlot(_ctx.$slots, "default", { date, isFocused: focused })]),
    _: 3
    /* FORWARDED */
...
var _sfc_main$Z = defineComponent({ name: "FCalendarDay", mixins: [TranslationMixin], props: {
  /**
  * Day to render.
  */
...
function _sfc_render$P(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    [createElementVNode(
      "span",
      _hoisted_1$J,
      toDisplayString(_ctx.day.day),
      1
      /* TEXT */
    ), createTextVNode(), createElementVNode(
      "span",
      _hoisted_2$x,
      toDisplayString(_ctx.srText),
      1
      /* TEXT */
    )],
    2
...
var _sfc_main$Y = defineComponent({ name: "IPopup", inheritAttrs: false, props: {
  /**
...
function _sfc_render$O(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.isOpen ? (openBlock(), createBlock(Teleport, { key: 0, to: _ctx.teleportTarget, disabled: _ctx.teleportDisabled }, [createElementVNode(
    "div",
    mergeProps({ ref: "popup" }, _ctx.$attrs, { class: _ctx.popupClasses }),
    [createElementVNode(
      "div",
      { ref: "wrapper", role: "presentation", class: "popup__wrapper", onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onPopupClickHandler && _ctx.onPopupClickHandler(...args)), onKeyup: _cache[1] || (_cache[1] = withKeys(withModifiers((...args) => _ctx.onKeyEsc && _ctx.onKeyEsc(...args), ["stop"]), ["esc"])), onKeydown: _cache[2] || (_cache[2] = withKeys((...args) => _ctx.onKeyTab && _ctx.onKeyTab(...args), ["tab"])) },
      [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({ toggleIsOpen: _ctx.toggleIsOpen, placement: _ctx.placement })))],
      544
...
var _sfc_main$X = defineComponent({ name: "FContextMenu", components: { IPopup, FIcon }, props: {
  /**
  * Toggle open/closed popup.
  */
  isOpen: { type: Boolean, required: true },
...
function _sfc_render$N(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_i_popup, { "is-open": _ctx.isOpen, "keyboard-trap": false, anchor: _ctx.anchor, "set-focus": true, "focus-element": () => _ctx.contextmenu, inline: "never", onClose: _cache[2] || (_cache[2] = ($event) => _ctx.$emit("close")) }, {
    default: withCtx(() => [createElementVNode("nav", { class: "contextmenu", "aria-label": _ctx.ariaLabel, onKeyup: _cache[0] || (_cache[0] = (...args) => _ctx.onKeyUp && _ctx.onKeyUp(...args)), onKeydown: _cache[1] || (_cache[1] = (...args) => _ctx.onKeyDown && _ctx.onKeyDown(...args)) }, [createElementVNode(
      "ul",
      _hoisted_2$w,
      [(openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList(_ctx.popupItems, (item, index) => {
          return openBlock(), createElementBlock("li", { key: item.key, role: "menuitem", onClick: ($event) => _ctx.onClickItem(item) }, [createElementVNode("div", { ref_for: true, ref: "items", tabindex: _ctx.tabIndex(index), class: "contextmenu__list__item" }, [_ctx.hasIcons ? (openBlock(), createBlock(_component_f_icon, { key: 0, class: "contextmenu__lefticon", name: item.icon ? item.icon : "", library: item.iconLibrary ? item.iconLibrary : "f" }, null, 8, ["name", "library"])) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode(
            "a",
            { ref_for: true, ref: "anchors" },
            toDisplayString(item.label),
            513
            /* TEXT, NEED_PATCH */
          )], 8, _hoisted_4$n), createTextVNode(), _ctx.hasSeparatorAfterItemAt(index) ? (openBlock(), createElementBlock("hr", _hoisted_5$l)) : createCommentVNode("v-if", true)], 8, _hoisted_3$s);
        }),
        128
        /* KEYED_FRAGMENT */
      ))],
...
var _sfc_main$W = defineComponent({ name: "FFieldset", components: { FIcon }, mixins: [TranslationMixin], props: {
  /**
...
function _sfc_render$M(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("fieldset", { id: _ctx.id, class: normalizeClass(["fieldset", _ctx.classes]), onValidity: _cache[0] || (_cache[0] = (...args) => _ctx.onValidity && _ctx.onValidity(...args)) }, [(openBlock(), createElementBlock(
    "legend",
    { key: _ctx.legendKey, class: normalizeClass(["label", _ctx.legendClass]) },
    [renderSlot(_ctx.$slots, "label"), createTextVNode(), _ctx.hasCheckbox && _ctx.children.length > 1 ? (openBlock(), createElementBlock("span", _hoisted_2$v, [createElementVNode(
      "span",
      null,
      toDisplayString(_ctx.numberOfCheckboxesScreenReaderText),
      1
      /* TEXT */
    )])) : createCommentVNode("v-if", true), createTextVNode(), renderSlot(_ctx.$slots, "description", normalizeProps(guardReactiveProps({ descriptionClass: _ctx.descriptionClass, discreteDescriptionClass: _ctx.discreteDescriptionClass }))), createTextVNode(), renderSlot(_ctx.$slots, "error-message", normalizeProps(guardReactiveProps({ hasError: _ctx.hasError, validationMessage: _ctx.validity.validationMessage })), () => [_ctx.hasError ? (openBlock(), createElementBlock("span", _hoisted_3$r, [createVNode(_component_f_icon, { class: "label__icon--left", name: "error" }), createTextVNode(
      " " + toDisplayString(_ctx.validity.validationMessage),
      1
      /* TEXT */
    )])) : createCommentVNode("v-if", true)])],
    2
    /* CLASS */
  )), createTextVNode(), _ctx.hasCheckbox ? (openBlock(), createElementBlock("span", _hoisted_4$m, [_ctx.children.length === 1 ? (openBlock(), createElementBlock(
    "span",
    _hoisted_5$k,
    toDisplayString(_ctx.checkboxCheckedScreenReaderText),
    1
    /* TEXT */
  )) : (openBlock(), createElementBlock(
    "span",
    _hoisted_6$g,
    toDisplayString(_ctx.numberOfCheckedCheckboxesScreenText),
    1
    /* TEXT */
  ))])) : createCommentVNode("v-if", true), createTextVNode(), _ctx.hasTooltipSlot ? (openBlock(), createElementBlock(
    Fragment,
    { key: 1 },
    [createElementVNode("div", _hoisted_7$d, [createElementVNode("div", _hoisted_8$9, [createElementVNode("div", _hoisted_9$5, [renderSlot(_ctx.$slots, "label")])]), createTextVNode(), renderSlot(_ctx.$slots, "tooltip")]), createTextVNode(), _ctx.hasDescriptionSlot || _ctx.hasErrorMessageSlot || _ctx.hasError ? (openBlock(), createElementBlock(
      "div",
      { key: 0, class: normalizeClass(["label", _ctx.groupLabelClass]), "aria-hidden": "true" },
      [renderSlot(_ctx.$slots, "description", normalizeProps(guardReactiveProps({ descriptionClass: _ctx.descriptionClass, discreteDescriptionClass: _ctx.discreteDescriptionClass }))), createTextVNode(), renderSlot(_ctx.$slots, "error-message", normalizeProps(guardReactiveProps({ hasError: _ctx.hasError, validationMessage: _ctx.validity.validationMessage })), () => [_ctx.hasError ? (openBlock(), createElementBlock("span", _hoisted_10$5, [createVNode(_component_f_icon, { class: "label__icon--left", name: "error" }), createTextVNode(
        " " + toDisplayString(_ctx.validity.validationMessage),
        1
        /* TEXT */
      )])) : createCommentVNode("v-if", true)])],
...
var _sfc_main$V = defineComponent({ name: "FCheckboxField", inheritAttrs: false, props: {
  /**
  ...
  */
  ...
  attrs() {
    ...
    if (Array.isArray(this.modelValue)) {
      checked = this.modelValue.findIndex((it) => (0, import_lodash.isEqual)(toValue(it), toValue(this.value))) >= 0;
    } else {
  ...
  let newModel;
  if (Array.isArray(this.modelValue)) {
    newModel = [...this.modelValue].filter((it) => !(0, import_lodash.isEqual)(toValue(it), toValue(this.value)));
...
var _hoisted_4$l = /* @__PURE__ */ createElementVNode(
  "br",
  null,
  null,
  -1
...
var _hoisted_6$f = /* @__PURE__ */ createElementVNode(
  "br",
  null,
  null,
  -1
...
function _sfc_render$L(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    [createElementVNode("input", mergeProps({ id: _ctx.id }, _ctx.attrs, { ref: "checkboxInput", type: "checkbox", class: "checkbox__input", disabled: _ctx.disabled, onKeydown: _cache[0] || (_cache[0] = withKeys((...args) => _ctx.onKeydown && _ctx.onKeydown(...args), ["space"])), onChange: _cache[1] || (_cache[1] = ($event) => _ctx.updateExpandedFlag()) }), null, 16, _hoisted_1$G), createTextVNode(), createElementVNode("label", { class: normalizeClass(_ctx.$slots.details ? "checkbox__label checkbox__width" : "checkbox__label"), for: _ctx.id }, [renderSlot(_ctx.$slots, "default"), createTextVNode(), _ctx.$slots.details ? (openBlock(), createElementBlock(
      Fragment,
      { key: 0 },
...
var _sfc_main$U = defineComponent({ name: "FCheckboxGroup", components: { FFieldset }, mixins: [TranslationMixin], inheritAttrs: false, props: {
  /**
  * The id for the fieldset id attribute.
...
function _sfc_render$K(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_fieldset, mergeProps({ id: _ctx.id, name: _ctx.name }, _ctx.$attrs), createSlots({
    ...
    "error-message": withCtx(() => [renderSlot(_ctx.$slots, "error-message")]),
    default: withCtx(() => [createTextVNode(), createTextVNode(), createTextVNode(), createTextVNode(), renderSlot(_ctx.$slots, "default")]),
    _: 2
    /* DYNAMIC */
  }, [_ctx.$slots.tooltip ? { name: "tooltip", fn: withCtx(() => [renderSlot(_ctx.$slots, "tooltip")]), key: "0" } : void 0]), 1040, ["id", "name"]);
}
...
var _sfc_main$T = defineComponent({ name: "FCrudDataset", components: { FFormModal, FConfirmModal, FIcon }, mixins: [TranslationMixin], provide() {
  return { delete: (item) => {
  ...
  */
  addNewModalHeader: { type: String, required: false, default: TranslationService.provider.translate("fkui.crud-dataset.modal.header.add", "L\xE4gg till rad") },
  /**
  * Property for changing the "modify" modal heading
  */
  modifyModalHeader: { type: String, required: false, default: TranslationService.provider.translate("fkui.crud-dataset.modal.header.modify", "\xC4ndra rad") },
  /**
  * Property for changing the "delete" modal heading
  */
  deleteModalHeader: { type: String, required: false, default: TranslationService.provider.translate("fkui.crud-dataset.modal.header.delete", "\xC4r du s\xE4ker p\xE5 att du vill ta bort raden?") }
  ...
  if (this.operation === Operation.ADD) {
    ...
    this.$emit("update:modelValue", this.result);
    this.$emit("change", this.result);
    alertScreenReader(this.$t("fkui.crud-dataset.aria-live.modify", "Raden har \xE4ndrats"), { assertive: true });
  }
  this.isFormModalOpen = false;
}, updateItem(item) {
...
function _sfc_render$J(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$F, [renderSlot(_ctx.$slots, "default"), createTextVNode(), _ctx.hasAddSlot ? (openBlock(), createElementBlock("div", _hoisted_2$t, [createElementVNode("button", { "data-test": "f-crud-dataset-add-button", type: "button", class: "button button--tertiary crud-dataset__add-button", onClick: _cache[0] || (_cache[0] = ($event) => _ctx.createItem()) }, [createVNode(_component_f_icon, { class: "button__icon", name: "plus" }), createTextVNode(), renderSlot(_ctx.$slots, "add-button", {}, () => [createTextVNode(
    toDisplayString(_ctx.$t("fkui.crud-dataset.button.add", "L\xE4gg till ny")),
    1
    /* TEXT */
  )])])])) : createCommentVNode("v-if", true), createTextVNode(), createVNode(_component_f_form_modal, { "is-open": _ctx.isFormModalOpen, "aria-close-text": _ctx.$t("fkui.crud-dataset.modal.close", "St\xE4ng"), "use-error-list": false, "before-submit": _ctx.beforeSubmit, "before-validation": _ctx.beforeValidation, "on-cancel": _ctx.onCancel, onClose: _ctx.onModalClose, onCancel: _ctx.onCancel, onSubmit: _ctx.onFormModalSubmit }, {
    header: withCtx(() => [createTextVNode(
      toDisplayString(_ctx.formModalHeader),
      1
      /* TEXT */
    )]),
    "input-text-fields": withCtx(() => [_ctx.operation === _ctx.Operation.ADD ? renderSlot(_ctx.$slots, "add", normalizeProps(mergeProps({ key: 0 }, { item: _ctx.item }))) : createCommentVNode("v-if", true), createTextVNode(), _ctx.operation === _ctx.Operation.MODIFY ? renderSlot(_ctx.$slots, "modify", normalizeProps(mergeProps({ key: 1 }, { item: _ctx.item }))) : createCommentVNode("v-if", true)]),
    "submit-button-text": withCtx(() => [createTextVNode(
      toDisplayString(_ctx.confirmButtonText),
      1
      /* TEXT */
    )]),
    "cancel-button-text": withCtx(() => [createTextVNode(
    ...
    _: 3
    /* FORWARDED */
  }, 8, ["is-open", "aria-close-text", "before-submit", "before-validation", "on-cancel", "onClose", "onCancel", "onSubmit"]), createTextVNode(), createVNode(_component_f_confirm_modal, { "is-open": _ctx.isConfirmModalOpen, buttons: _ctx.confirmDeleteButtons, onConfirm: _ctx.onDeleteConfirm, onClose: _ctx.onDeleteClose }, {
    heading: withCtx(() => [createTextVNode(
      toDisplayString(_ctx.deleteModalHeader),
      1
      /* TEXT */
    )]),
    content: withCtx(() => [renderSlot(_ctx.$slots, "delete", normalizeProps(guardReactiveProps({ item: _ctx.item })))]),
    _: 3
    /* FORWARDED */
...
function FCrudDatasetInjected() {
  return { delete: inject("delete"), modify: inject("modify") };
}
var _sfc_main$S = defineComponent({ name: "FCrudButton", components: { FIcon }, mixins: [TranslationMixin], props: { action: { type: String, required: true, validator(value) {
...
function _sfc_render$I(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("button", { type: "button", class: "button button--small button--tertiary", onClick: _cache[0] || (_cache[0] = (...args) => _ctx.executeAction && _ctx.executeAction(...args)) }, [_ctx.icon ? (openBlock(), createBlock(_component_f_icon, { key: 0, class: "button__icon", name: _ctx.iconName }, null, 8, ["name"])) : createCommentVNode("v-if", true), createTextVNode(), !_ctx.label ? (openBlock(), createElementBlock("span", _hoisted_1$E, [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(
    toDisplayString(_ctx.buttonText),
    1
    /* TEXT */
  )])])) : createCommentVNode("v-if", true), createTextVNode(), _ctx.label ? renderSlot(_ctx.$slots, "default", { key: 2 }, () => [createTextVNode(
    toDisplayString(_ctx.buttonText),
    1
    /* TEXT */
  )]) : createCommentVNode("v-if", true)]);
...
var _sfc_main$R = defineComponent({ name: "FTableColumn", inheritAttrs: false, props: {
  /**
...
var _hoisted_1$D = /* @__PURE__ */ createElementVNode(
  "span",
  { class: "sr-only" },
  "\xA0",
  -1
...
function _sfc_render$H(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.renderColumns && _ctx.visible ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.tagName), mergeProps({ key: 0, class: _ctx.classes, scope: _ctx.scope }, _ctx.$attrs), {
    default: withCtx(() => [renderSlot(_ctx.$slots, "default"), createTextVNode(), _hoisted_1$D]),
    _: 3
    /* FORWARDED */
  }, 16, ["class", "scope"])) : createCommentVNode("v-if", true);
}
...
var _sfc_main$Q = defineComponent({ name: "FLabel", components: { FIcon }, props: {
  /**
...
var _sfc_main$P = defineComponent({ name: "FSelectField", components: { FIcon, FLabel }, inheritAttrs: false, props: {
  /**
...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [createElementVNode(
      ...
      [withDirectives(createElementVNode("select", mergeProps({ id: _ctx.id, "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.vModel = $event), class: "select-field__select" }, _ctx.attrs), [renderSlot(_ctx.$slots, "default")], 16, _hoisted_1$B), [[vModelSelect, _ctx.vModel]]), createTextVNode(), _ctx.hasError && _ctx.textFieldTableMode ? (openBlock(), createBlock(
        _component_f_icon,
...
var _sfc_main$O = defineComponent({ name: "IPopupError", components: { FIcon }, inheritAttrs: false, props: {
  /**
...
function _sfc_render$E(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return _ctx.isOpen ? (openBlock(), createBlock(Teleport, { key: 0, to: "body", disabled: _ctx.teleportDisabled }, [createElementVNode(
    "div",
    ...
    [createElementVNode(
      ...
      [createElementVNode(
        ...
        [createElementVNode(
          ...
          1
          /* TEXT */
        ), createTextVNode(), createElementVNode("button", { tabindex: "-1", type: "button", class: "button button--discrete button--discrete--black modal__close-button popup-error__button", "aria-label": "St\xE4ng", onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClose && _ctx.onClose(...args)) }, [createVNode(_component_f_icon, { name: "close", class: "button__icon" })])],
        6
        /* CLASS, STYLE */
      )],
      512
...
var _sfc_main$N = defineComponent({ name: "FTextField", components: { FLabel, FIcon, IPopupError }, inheritAttrs: false, props: {
  /**
  * The id for the input id attribute.
  * The id for the label for attribute.
  * If the prop is not set a random value will be generated.
...
var _sfc_main$M = defineComponent({ name: "FEmailTextField", components: { FTextField }, mixins: [TranslationMixin], inheritAttrs: false, props: {
  /**
  * The id for the input id attribute.
  * The id for the label for attribute.
  * If the prop is not set a random value will be generated.
  ...
  */
  pasteErrorText: { type: String, required: false, default: TranslationService.provider.translate("fkui.email-text-field.error.pasting", "Du kan inte kopiera mejladressen. Du m\xE5ste skriva in den igen.") }
...
function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [createVNode(_component_f_text_field, mergeProps({ id: _ctx.id, type: "email", maxlength: _ctx.maxLength }, _ctx.$attrs, { "model-value": _ctx.modelValue, onChange: _ctx.onChange, onBlur: _ctx.onBlur, onUpdate: _ctx.onUpdate, onValidity: _ctx.onValidity, onPendingValidity: _ctx.onPendingValidity }), {
    "error-message": withCtx(() => [_ctx.showPasteErrorMessage ? (openBlock(), createElementBlock(
      "span",
      _hoisted_1$y,
      toDisplayString(_ctx.pasteErrorText),
      1
      /* TEXT */
    )) : createCommentVNode("v-if", true)]),
    ...
    _: 3
    /* FORWARDED */
  }, 16, ["id", "maxlength", "model-value", "onChange", "onBlur", "onUpdate", "onValidity", "onPendingValidity"]), createTextVNode(), _ctx.extendedValidation ? (openBlock(), createBlock(_component_f_text_field, { key: 0, modelValue: _ctx.secondEmail, "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.secondEmail = $event), type: "email", maxlength: _ctx.maxLength, onPaste: _ctx.onPaste, onBlur: _cache[1] || (_cache[1] = ($event) => _ctx.showPasteErrorMessage = false) }, {
    default: withCtx(() => [renderSlot(_ctx.$slots, "extended-label", {}, () => [createTextVNode(
      toDisplayString(_ctx.$t("fkui.email-text-field.label.repeat", "Upprepa mejladress")),
      1
      /* TEXT */
    )])]),
    _: 3
    /* FORWARDED */
  }, 8, ["modelValue", "maxlength", "onPaste"])) : createCommentVNode("v-if", true)]);
}
var FEmailTextField = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render$C]]);
var _sfc_main$L = defineComponent({ name: "FPhoneTextField", components: { FTextField }, mixins: [TranslationMixin], inheritAttrs: false, props: {
  /**
  * The id for the input id attribute.
  * The id for the label for attribute.
  * If the prop is not set a random value will be generated.
...
function _sfc_render$B(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [createVNode(_component_f_text_field, mergeProps({ id: _ctx.id, type: "tel", maxlength: _ctx.maxLength }, _ctx.$attrs, { "model-value": _ctx.modelValue, onChange: _ctx.onChange, onBlur: _ctx.onBlur, onUpdate: _ctx.onUpdate, onValidity: _ctx.onValidity, onPendingValidity: _ctx.onPendingValidity }), {
    ...
    _: 3
    /* FORWARDED */
  }, 16, ["id", "maxlength", "model-value", "onChange", "onBlur", "onUpdate", "onValidity", "onPendingValidity"]), createTextVNode(), _ctx.extendedValidation ? (openBlock(), createBlock(_component_f_text_field, { key: 0, modelValue: _ctx.secondPhone, "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.secondPhone = $event), type: "tel", maxlength: _ctx.maxLength }, {
    default: withCtx(() => [renderSlot(_ctx.$slots, "extendedLabel", {}, () => [createTextVNode(
      toDisplayString(_ctx.$t("fkui.phone-text-field.label.repeat", "Upprepa telefonnumret")),
      1
      /* TEXT */
    )])]),
    _: 3
    /* FORWARDED */
  }, 8, ["modelValue", "maxlength"])) : createCommentVNode("v-if", true)]);
}
var FPhoneTextField = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["render", _sfc_render$B]]);
var _sfc_main$K = defineComponent({ name: "FCurrencyTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: formatNumber }, parser: { type: Function, required: false, default: parseNumber } }, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  ...
  ValidationService.addValidatorsToElement(inputElement, { currency: {}, integer: {} }, true);
  ValidationService.validateElement(inputElement);
} });
var _sfc_main$J = defineComponent({ name: "FSearchTextField", components: { FTextField, FIcon }, props: { id: { type: String, required: false, default: () => ElementIdService.generateElementId() }, modelValue: { type: String, required: false, default: "" }, clearableScreenReaderText: { type: String, required: false, default: TranslationService.provider.translate("fkui.search-text-field.search-screen-reader", "T\xF6m inmatningsf\xE4lt") }, maxLength: { type: Number, default: 80 } }, emits: ["blur", "change", "update", "update:modelValue"], data() {
  return { defaultText: this.$t("fkui.search-text-field.label", "S\xF6k") };
}, computed: { canClear() {
  return this.modelValue !== "";
} }, methods: { clear() {
  alertScreenReader(this.$t("fkui.search-text-field.aria-live.clear", "Inmatningsf\xE4ltet har t\xF6mts"), { assertive: true });
...
function _sfc_render$A(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  const _component_f_text_field = resolveComponent("f-text-field");
  return openBlock(), createElementBlock("div", null, [createVNode(_component_f_text_field, mergeProps({ id: _ctx.id, maxlength: _ctx.maxLength, "model-value": _ctx.modelValue }, _ctx.$attrs, { type: "search", class: "text-field--search", onChange: _ctx.onChange, onInput: _ctx.onInput, onBlur: _ctx.onBlur, onUpdate: _ctx.onUpdate }), createSlots({
    "input-right": withCtx(() => [renderSlot(_ctx.$slots, "input-right")]),
    "input-left": withCtx(() => [renderSlot(_ctx.$slots, "input-left")]),
    "error-message": withCtx(({ hasError, validationMessage }) => [renderSlot(_ctx.$slots, "error-message", normalizeProps(guardReactiveProps({ hasError, validationMessage })))]),
    description: withCtx(({ descriptionClass, discreteDescriptionClass }) => [renderSlot(_ctx.$slots, "description", normalizeProps(guardReactiveProps({ descriptionClass, discreteDescriptionClass })))]),
    default: withCtx(() => [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(
      toDisplayString(_ctx.defaultText),
      1
      /* TEXT */
    )]), createTextVNode(), createTextVNode(), createTextVNode(), createTextVNode(), createTextVNode(), createTextVNode()]),
    _: 2
    /* DYNAMIC */
  }, [_ctx.$slots.tooltip ? { name: "tooltip", fn: withCtx(() => [renderSlot(_ctx.$slots, "tooltip")]), key: "0" } : void 0, _ctx.canClear ? { name: "append-inner", fn: withCtx(() => [createElementVNode("button", { class: "text-field__icon clear-button", type: "button", onClick: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.clear && _ctx.clear(...args), ["self"])) }, [createVNode(_component_f_icon, { name: "cross", class: "clear-button__icon" }), createTextVNode(), createElementVNode(
    "span",
    _hoisted_1$x,
    toDisplayString(_ctx.clearableScreenReaderText),
    1
    /* TEXT */
...
var _sfc_main$I = defineComponent({ name: "FBankAccountNumberTextField", extends: FTextField, mixins: [TranslationMixin], props: { parser: { type: Function, required: false, default: parseBankAccountNumber } }, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  return { defaultText: this.$t("fkui.bank-account-number-text-field.label", "Kontonummer") };
}, mounted() {
  const inputElement = getInputElement(this);
  ValidationService.addValidatorsToElement(inputElement, { bankAccountNumber: {} }, true);
  inputElement.setAttribute("inputmode", "numeric");
  inputElement.setAttribute("maxlength", "40");
  ValidationService.validateElement(inputElement);
} });
var _sfc_main$H = defineComponent({ name: "FBankgiroTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: parseBankgiro } }, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  return { defaultText: this.$t("fkui.bankgiro-text-field.label", "Bankgironummer") };
}, mounted() {
  const inputElement = getInputElement(this);
  ValidationService.addValidatorsToElement(inputElement, { maxLength: { length: 9 }, bankgiro: {} }, true);
  inputElement.setAttribute("inputmode", "numeric");
  inputElement.setAttribute("maxlength", "40");
  ValidationService.validateElement(inputElement);
} });
var _sfc_main$G = defineComponent({ name: "FClearingnumberTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: parseClearingNumber } }, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  return { defaultText: this.$t("fkui.clearingnumber-text-field.label", "Clearingnummer") };
}, mounted() {
  const inputElement = getInputElement(this);
  ValidationService.addValidatorsToElement(inputElement, { clearingNumber: {} }, true);
  inputElement.setAttribute("inputmode", "numeric");
...
var _sfc_main$F = defineComponent({ name: "FNumericTextField", extends: FTextField, props: {
  /**
  ...
  */
  ...
  parser: { type: Function, required: false, default: parseNumber }
}, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, mounted() {
  const inputElement = getInputElement(this);
...
var _sfc_main$E = defineComponent({ name: "FPersonnummerTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: formatPersonnummer }, parser: { type: Function, required: false, default: parsePersonnummer } }, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  ...
  const inputElement = getInputElement(this);
  ValidationService.addValidatorsToElement(inputElement, { maxLength: { length: 20 }, personnummerFormat: {}, personnummerLuhn: {} }, true);
  inputElement.setAttribute("inputmode", "numeric");
  inputElement.setAttribute("maxlength", "23");
  ValidationService.validateElement(inputElement);
} });
var _sfc_main$D = defineComponent({ name: "FPlusgiroTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: parsePlusgiro } }, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  return { defaultText: this.$t("fkui.plusgiro-text-field.label", "Plusgironummer") };
}, mounted() {
  const inputElement = getInputElement(this);
  ValidationService.addValidatorsToElement(inputElement, { maxLength: { length: 11 }, plusgiro: {} }, true);
  inputElement.setAttribute("inputmode", "numeric");
  inputElement.setAttribute("maxlength", "16");
  ValidationService.validateElement(inputElement);
} });
var _sfc_main$C = defineComponent({ name: "FPostalCodeTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: formatPostalCode } }, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  ...
  const inputElement = getInputElement(this);
  ValidationService.addValidatorsToElement(inputElement, { maxLength: { length: 13 }, postalCode: {} }, true);
  inputElement.setAttribute("inputmode", "numeric");
...
var _sfc_main$B = defineComponent({ name: "FPercentTextField", extends: FTextField, mixins: [TranslationMixin], props: {
  /**
  * The number of decimals to format number as.
  */
  decimals: { type: Number, required: false, default: void 0 },
  formatter: { type: Function, required: false, default: defaultFormatter },
  parser: { type: Function, required: false, default: parsePercent }
}, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  ...
  ValidationService.addValidatorsToElement(inputElement, { percent: {}, minValue: { minValue: 0 }, maxValue: { maxValue: 999 } }, true);
  ValidationService.validateElement(inputElement);
} });
var _sfc_main$A = defineComponent({ name: "FOrganisationsnummerTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: parseOrganisationsnummer } }, setup() {
  return { textFieldTableMode: inject("textFieldTableMode", false) };
}, data() {
  ...
  const inputElement = getInputElement(this);
  ValidationService.addValidatorsToElement(inputElement, { maxLength: { length: 11 }, organisationsnummer: {} }, true);
  inputElement.setAttribute("inputmode", "numeric");
  inputElement.setAttribute("maxlength", "20");
  ValidationService.validateElement(inputElement);
} });
...
var _sfc_main$z = defineComponent({ name: "FSortFilterDataset", components: { FSelectField, FTextField, FIcon, IFlex, IFlexItem }, mixins: [TranslationMixin], provide() {
  ...
  */
  ...
  if (this.searchString === "") {
    alertScreenReader(this.$t("fkui.sort-filter-dataset.aria-live.empty", "S\xF6k redigera S\xF6k tom"));
  } else {
...
function _sfc_render$z(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_i_flex = resolveComponent("i-flex");
  return openBlock(), createElementBlock("div", _hoisted_1$w, [createVNode(_component_i_flex, { collapse: "", gap: "3x", wrap: "" }, {
    default: withCtx(() => [createVNode(_component_i_flex_item, { shrink: "", align: "center" }, {
      ...
      _: 3
      /* FORWARDED */
    }), createTextVNode(), createVNode(_component_i_flex_item, { grow: "" }, {
      default: withCtx(() => [createVNode(_component_i_flex, { collapse: "", float: "right" }, {
        default: withCtx(() => [_ctx.showFilter ? (openBlock(), createBlock(_component_i_flex_item, { key: 0, shrink: "", align: "center" }, {
          default: withCtx(() => [createElementVNode("div", _hoisted_2$q, [createVNode(_component_f_icon, { name: "search", class: "sort-filter-dataset__search__magnify-icon" }), createTextVNode(), createVNode(_component_f_text_field, { modelValue: _ctx.searchString, "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.searchString = $event), inline: "", placeholder: _ctx.placeholderFilter, maxlength: "64", onInput: _ctx.onSearchInput }, {
            default: withCtx(() => [createElementVNode(
              "span",
              _hoisted_3$n,
              toDisplayString(_ctx.placeholderFilter),
              1
              /* TEXT */
            )]),
            _: 1
            /* STABLE */
          }, 8, ["modelValue", "placeholder", "onInput"]), createTextVNode(), _ctx.showClearButton ? (openBlock(), createElementBlock("button", { key: 0, type: "button", class: "button button--discrete sort-filter-dataset__search__close-icon", title: _ctx.$t("fkui.sort-filter-dataset.clear.filter", "Rensa s\xF6kf\xE4lt"), onClick: _cache[1] || (_cache[1] = (...args) => _ctx.onClickClearSearch && _ctx.onClickClearSearch(...args)) }, [createVNode(_component_f_icon, { name: "close" }), createTextVNode(), createElementVNode(
            "span",
            _hoisted_5$g,
            toDisplayString(_ctx.$t("fkui.sort-filter-dataset.clear.filter", "Rensa s\xF6kf\xE4lt")),
            1
            /* TEXT */
          )], 8, _hoisted_4$i)) : createCommentVNode("v-if", true)])]),
          _: 1
          /* STABLE */
        })) : createCommentVNode("v-if", true), createTextVNode(), _ctx.showSort ? (openBlock(), createBlock(_component_i_flex_item, { key: 1, shrink: "", align: "center" }, {
          default: withCtx(() => [createVNode(_component_f_select_field, { modelValue: _ctx.sortAttribute, "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.sortAttribute = $event), class: "sort-filter-dataset__sort", inline: "", onChange: _ctx.onChangeSortAttribute }, {
            label: withCtx(() => [createTextVNode(
              toDisplayString(_ctx.$t("fkui.sort-filter-dataset.label.sort", "Sortera\xA0p\xE5")),
              1
              /* TEXT */
            )]),
            default: withCtx(() => [createTextVNode(), createElementVNode(
              "option",
              _hoisted_6$c,
              toDisplayString(_ctx.$t("fkui.sort-filter-dataset.label.unsorted", "V\xE4lj")),
              1
              /* TEXT */
            ), createTextVNode(), (openBlock(true), createElementBlock(
              Fragment,
              null,
              renderList(_ctx.sortOrders, (sortOrder) => {
                return openBlock(), createElementBlock("option", { key: sortOrder.id, value: sortOrder }, toDisplayString(sortOrder.name) + " (" + toDisplayString(sortOrder.ascendingName) + ")\n                            ", 9, _hoisted_7$b);
              }),
              128
              /* KEYED_FRAGMENT */
            ))]),
    ...
    _: 3
    /* FORWARDED */
  }), createTextVNode(), renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({ sortFilterResult: _ctx.sortFilterResult })))]);
}
var FSortFilterDataset = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["render", _sfc_render$z]]);
var _sfc_main$y = defineComponent({ name: "FDataTable", components: { FIcon }, mixins: [TranslationMixin], provide() {
...
function _sfc_render$y(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [createElementVNode("table", mergeProps({ class: ["table", _ctx.tableClasses], tabindex: _ctx.tabindex }, _ctx.$attrs), [_ctx.hasCaption ? (openBlock(), createElementBlock("caption", _hoisted_2$p, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode("colgroup", null, [(openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.columns, (column) => {
        return openBlock(), createElementBlock(
          "col",
          { key: column.id, class: normalizeClass(column.size) },
          null,
          2
          /* CLASS */
        );
      ...
      128
      /* KEYED_FRAGMENT */
    ))]), createTextVNode(), createElementVNode("thead", null, [createElementVNode("tr", _hoisted_3$m, [(openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.visibleColumns, (column) => {
        return openBlock(), createElementBlock(
          "th",
          mergeProps({ key: column.id, scope: "col", class: _ctx.columnClasses(column) }, toHandlers(column.sortable ? { click: () => _ctx.onClickColumnHeader(column) } : {}, true)),
          [createElementVNode("span", { innerHTML: _ctx.escapeNewlines(column.title) }, null, 8, _hoisted_4$h), createTextVNode(), column.sortable ? (openBlock(), createBlock(_component_f_icon, { key: 0, class: normalizeClass(_ctx.iconClasses(column)), name: _ctx.iconName(column) }, null, 8, ["class", "name"])) : createCommentVNode("v-if", true), createTextVNode(), column.description ? (openBlock(), createElementBlock(
            "span",
            _hoisted_5$f,
            toDisplayString(column.description),
            1
            /* TEXT */
          )) : createCommentVNode("v-if", true)],
          16
      ...
      128
      /* KEYED_FRAGMENT */
    ))])]), createTextVNode(), createElementVNode("tbody", null, [_ctx.isEmpty && _ctx.columns.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_6$b, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({ row: {} })))])) : createCommentVNode("v-if", true), createTextVNode(), _ctx.isEmpty ? (openBlock(), createElementBlock("tr", _hoisted_7$a, [createElementVNode("td", { class: "table__column table__column--action", colspan: _ctx.columns.length }, [renderSlot(_ctx.$slots, "empty", {}, () => [createTextVNode(
      toDisplayString(_ctx.$t("fkui.data-table.empty", "Tabellen \xE4r tom")),
      1
      /* TEXT */
    )])], 8, _hoisted_8$8)])) : createCommentVNode("v-if", true), createTextVNode(), (openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.rows, (row) => {
        return openBlock(), createElementBlock("tr", { key: _ctx.rowKey(row), class: "table__row" }, [renderSlot(_ctx.$slots, "default", mergeProps({ ref_for: true }, { row }))]);
      }),
      128
      /* KEYED_FRAGMENT */
    ))])], 16, _hoisted_1$v)],
...
var _sfc_main$x = defineComponent({ name: "FDatepickerField", components: { FCalendar, IPopup, FTextField, FIcon, FCalendarDay }, mixins: [TranslationMixin], inheritAttrs: false, props: {
  /** Selected day.
  * @model
  */
  ...
  */
  ...
  return { textFieldValue: ref(""), textFieldTouched: ref(false), textFieldValidityRevealed: ref(false), textFieldTableMode: inject("textFieldTableMode", false), componentTouched: ref(false), calendarMonth: shallowRef(getDisplayMonth(defaultMinDate, defaultMaxDate)), calendarValue: shallowRef(void 0), isCalendarOpen: ref(false), validationConfig: ref({}), minDate: shallowRef(defaultMinDate), maxDate: shallowRef(defaultMaxDate), calendarInputs: ref(null) };
  ...
  ValidationService.addValidatorsToElement(getInputElement(this), { date: {}, dateFormat: {}, minDate: { limit: this.minDate.toString() }, maxDate: { limit: this.maxDate.toString() } }, true);
}, methods: { dateFormatter: parseDate, async onValidityTextField({ detail }) {
...
function _sfc_render$x(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [createElementVNode(
      ...
      [createVNode(_component_f_text_field, mergeProps(_ctx.$attrs, { modelValue: _ctx.textFieldValue, "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.textFieldValue = $event), maxlength: "20", disabled: _ctx.disabled, formatter: _ctx.dateFormatter, "label-width": _ctx.labelWidth, "input-width": _ctx.inputWidth, onComponentValidity: _ctx.onValidityTextField, onChange: _ctx.onChangeTextField, onValidationConfigUpdate: _ctx.onValidationConfigUpdate }), createSlots({
        description: withCtx(({ descriptionClass, discreteDescriptionClass }) => [renderSlot(_ctx.$slots, "description", normalizeProps(guardReactiveProps({ descriptionClass, discreteDescriptionClass })))]),
        "error-message": withCtx(({ hasError, validationMessage }) => [renderSlot(_ctx.$slots, "error-message", normalizeProps(guardReactiveProps({ hasError, validationMessage })))]),
        "input-right": withCtx(() => [createElementVNode("button", { ref: "calendarButton", disabled: _ctx.disabled, class: "datepicker-field__button", type: "button", "aria-expanded": _ctx.isCalendarOpen ? "true" : "false", "data-test": "calendar-button", onClick: _cache[0] || (_cache[0] = ($event) => _ctx.onClickCalendarButton()) }, [createVNode(_component_f_icon, { name: "calendar" }), createTextVNode(), createElementVNode(
          "span",
          _hoisted_3$l,
          toDisplayString(_ctx.calendarButtonText),
          1
          /* TEXT */
        )], 8, _hoisted_2$o)]),
        default: withCtx(() => [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(
          toDisplayString(_ctx.$t("fkui.datepicker-field.label", "Datum")),
          1
          /* TEXT */
        )]), createTextVNode(), createTextVNode(), createTextVNode(), createTextVNode()]),
        _: 2
        /* DYNAMIC */
      }, [_ctx.$slots.tooltip ? { name: "tooltip", fn: withCtx(() => [renderSlot(_ctx.$slots, "tooltip")]), key: "0" } : void 0]), 1040, ["modelValue", "disabled", "formatter", "label-width", "input-width", "onComponentValidity", "onChange", "onValidationConfigUpdate"])],
      544
      /* NEED_HYDRATION, NEED_PATCH */
    ), createTextVNode(), createVNode(_component_i_popup, { "is-open": _ctx.isCalendarOpen, anchor: _ctx.calendarInputs, inline: _ctx.alwaysInline ? "always" : void 0, "set-focus": false, onOpen: _ctx.onOpenPopup, onClose: _ctx.onClosePopup }, {
      default: withCtx(() => [createElementVNode(
        "div",
        { ref: "popup", class: normalizeClass(_ctx.popupClass) },
        [createVNode(_component_f_calendar, { modelValue: _ctx.calendarMonth, "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.calendarMonth = $event), "tab-date": _ctx.calendarValue, "min-date": _ctx.minDate, "max-date": _ctx.maxDate, onClick: _ctx.onSelectCalendarDay, onKeyup: withKeys(withModifiers(_ctx.onKeyupEsc, ["stop"]), ["esc", "native"]) }, {
          default: withCtx(({ date, isFocused }) => [createVNode(_component_f_calendar_day, { day: date, enabled: _ctx.isDateEnabled(date), focused: isFocused, highlight: _ctx.highlightDay(date), selected: _ctx.isDaySelected(date) }, null, 8, ["day", "enabled", "focused", "highlight", "selected"])]),
          _: 1
          /* STABLE */
        }, 8, ["modelValue", "tab-date", "min-date", "max-date", "onClick", "onKeyup"]), createTextVNode(), createElementVNode("div", _hoisted_4$g, [createElementVNode(
          "button",
          { class: "button button--discrete button--discrete--black datepicker-field__close__button", type: "button", onClick: _cache[4] || (_cache[4] = (...args) => _ctx.onClickCloseCalendarButton && _ctx.onClickCloseCalendarButton(...args)), onKeyup: _cache[5] || (_cache[5] = withKeys(withModifiers((...args) => _ctx.onKeyupEsc && _ctx.onKeyupEsc(...args), ["stop"]), ["esc"])) },
          [createElementVNode(
            "span",
            null,
            toDisplayString(_ctx.$t("fkui.datepicker-field.close", "St\xE4ng")),
            1
            /* TEXT */
          ), createTextVNode(), createVNode(_component_f_icon, { "aria-hidden": "true", class: "button__icon", name: "close" })],
          32
          /* NEED_HYDRATION */
        )])],
        2
...
var _sfc_main$w = defineComponent({ name: "FExpand", data() {
...
var _sfc_main$v = defineComponent({ name: "FExpandablePanel", components: { FIcon, FExpand }, mixins: [TranslationMixin], inheritAttrs: false, props: {
  /**
...
function _sfc_render$v(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [(openBlock(), createBlock(resolveDynamicComponent(_ctx.headerTag), { class: "expandable-panel__heading" }, {
      default: withCtx(() => [createElementVNode("button", mergeProps({ type: "button", "aria-expanded": _ctx.expanded ? "true" : "false", "aria-controls": _ctx.id }, _ctx.$attrs, { onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClickHeadingButton && _ctx.onClickHeadingButton(...args)) }), [createElementVNode("span", _hoisted_2$n, [createElementVNode("span", _hoisted_3$k, [createVNode(_component_f_icon, { name: "dash" }), createTextVNode(), createVNode(_component_f_icon, { name: "dash" })])]), createTextVNode(), renderSlot(_ctx.$slots, "title"), createTextVNode(), _ctx.haveNotifications ? (openBlock(), createElementBlock("span", { key: 0, class: "expandable-panel__notification", title: _ctx.$t("fkui.expandable-panel.notification.title", "{{ count }} notifiering{{ suffix }}", { count: _ctx.notifications, suffix: _ctx.notifications > 1 ? "ar" : "" }) }, [createElementVNode(
        "span",
        _hoisted_5$e,
        toDisplayString(_ctx.screenReaderNotificationText),
        1
        /* TEXT */
      ), createTextVNode(), createVNode(_component_f_icon, { name: "bell" })], 8, _hoisted_4$f)) : createCommentVNode("v-if", true)], 16, _hoisted_1$t)]),
      _: 3
      /* FORWARDED */
    })), createTextVNode(), createVNode(_component_f_expand, null, {
      default: withCtx(() => [withDirectives(createElementVNode("div", { id: _ctx.id, class: "expandable-panel__content" }, [createElementVNode("div", _hoisted_7$9, [renderSlot(_ctx.$slots, "default")]), createTextVNode(), _ctx.hasOutsideSlot ? (openBlock(), createElementBlock("div", _hoisted_8$7, [renderSlot(_ctx.$slots, "outside")])) : createCommentVNode("v-if", true)], 8, _hoisted_6$a), [[vShow, _ctx.expanded]])]),
      _: 3
      /* FORWARDED */
    })],
    2
...
var _sfc_main$u = defineComponent({ name: "FExpandableParagraph", components: { FIcon, FExpand }, inheritAttrs: false, props: {
  /**
  * Toggle expanded/collapsed state
  */
  expanded: { type: Boolean, required: false, default: false },
  ...
  return openBlock(), createElementBlock(
    ...
    [createElementVNode(
      ...
      [(openBlock(), createBlock(resolveDynamicComponent(_ctx.headerTag), { class: normalizeClass(["expandable-paragraph__heading", _ctx.headerVisualClass]) }, {
        default: withCtx(() => [createElementVNode("button", mergeProps({ type: "button", class: "expandable-paragraph__button", "aria-expanded": _ctx.expanded ? "true" : "false", "aria-controls": _ctx.id }, _ctx.$attrs, { onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClickMinimize && _ctx.onClickMinimize(...args)) }), [createElementVNode("span", _hoisted_2$m, [createElementVNode("span", _hoisted_3$j, [createVNode(_component_f_icon, { name: "dash" }), createTextVNode(), createVNode(_component_f_icon, { name: "dash" })])]), createTextVNode(), renderSlot(_ctx.$slots, "title")], 16, _hoisted_1$s)]),
        _: 3
        /* FORWARDED */
      }, 8, ["class"])), createTextVNode(), _ctx.hasRelatedSlot ? (openBlock(), createElementBlock("div", _hoisted_4$e, [renderSlot(_ctx.$slots, "related")])) : createCommentVNode("v-if", true)],
      2
      /* CLASS */
    ), createTextVNode(), createVNode(_component_f_expand, null, {
      default: withCtx(() => [withDirectives(createElementVNode("div", { id: _ctx.id, class: "expandable-paragraph__container" }, [createElementVNode("div", _hoisted_6$9, [renderSlot(_ctx.$slots, "default")]), createTextVNode(), !_ctx.list ? (openBlock(), createElementBlock("div", _hoisted_7$8)) : createCommentVNode("v-if", true)], 8, _hoisted_5$d), [[vShow, _ctx.expanded]])]),
      _: 3
      /* FORWARDED */
    })],
    2
...
var _sfc_main$t = defineComponent({ name: "FFileItem", components: { FIcon }, inheritAttrs: false, props: {
  /**
  * The id for the input id attribute.
  * The id for the label for attribute.
  * If the prop is not set a random value will be generated.
...
var _hoisted_8$6 = /* @__PURE__ */ createElementVNode(
  "hr",
...
function _sfc_render$t(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$r, [createElementVNode("div", _hoisted_2$l, [createElementVNode("a", mergeProps({ id: _ctx.id, class: "file-item__file-open" }, _ctx.$attrs), [createElementVNode("div", _hoisted_4$d, [createVNode(_component_f_icon, { name: "new-window" }), createTextVNode(), createVNode(_component_f_icon, { name: _ctx.iconName }, null, 8, ["name"])]), createTextVNode(), createElementVNode(
    "span",
    _hoisted_5$c,
    ...
    "span",
    _hoisted_6$8,
    "\xA0" + toDisplayString(_ctx.$t("fkui.file-item.file-open", "\xF6ppnas i nytt f\xF6nster")),
    1
    /* TEXT */
  )], 16, _hoisted_3$i), createTextVNode(), renderSlot(_ctx.$slots, "row")]), createTextVNode(), renderSlot(_ctx.$slots, "default"), createTextVNode(), _ctx.isMimeTypeChanged ? (openBlock(), createElementBlock(
    "div",
    _hoisted_7$7,
    toDisplayString(_ctx.mimeTypeChangedText),
    1
    /* TEXT */
  )) : createCommentVNode("v-if", true), createTextVNode(), _hoisted_8$6]);
}
var FFileItem = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["render", _sfc_render$t]]);
var _sfc_main$s = defineComponent({ name: "FFileSelector", components: { FIcon }, inheritAttrs: false, model: { prop: "files", event: "change" }, props: {
  /**
  * The id for the input id attribute.
  * The id for the label for attribute.
  * If the prop is not set a random value will be generated.
...
function _sfc_render$s(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$q, [createElementVNode("input", mergeProps({ id: _ctx.id, ref: "file-selector", type: "file", "aria-labelledby": _ctx.labelId, "aria-disabled": _ctx.ariaDisabled ? "true" : void 0 }, _ctx.attrs, { onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClick && _ctx.onClick(...args)) }), null, 16, _hoisted_2$k), createTextVNode(), createElementVNode("label", { id: _ctx.labelId, role: "button", class: normalizeClass([_ctx.labelClass, "button button--tertiary button--medium"]), for: _ctx.id, "aria-hidden": "true" }, [createVNode(_component_f_icon, { class: "button__icon", name: "paper-clip" }), createTextVNode(), renderSlot(_ctx.$slots, "default")], 10, _hoisted_3$h)]);
}
...
var _sfc_main$r = defineComponent({ name: "FMessageBox", components: { FIcon, IFlex, IFlexItem }, props: {
  /**
...
function _sfc_render$r(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [_ctx.provideScreenReaderContext ? (openBlock(), createElementBlock(
      "span",
      _hoisted_1$p,
      toDisplayString(_ctx.screenReaderContext()),
      1
      /* TEXT */
    )) : createCommentVNode("v-if", true), createTextVNode(), createVNode(_component_i_flex, { gap: "2x" }, {
      default: withCtx(() => [_ctx.layout === "short" ? (openBlock(), createBlock(_component_i_flex_item, { key: 0, class: "message-box__icon", shrink: "", align: "center" }, {
        default: withCtx(() => [createElementVNode(
          "span",
          { class: normalizeClass(["icon-stack", _ctx.stackTypeClass]) },
          [createVNode(_component_f_icon, { class: normalizeClass(_ctx.classType), name: _ctx.symbol }, null, 8, ["class", "name"]), createTextVNode(), createVNode(_component_f_icon, { class: normalizeClass(_ctx.classIcon), name: _ctx.sign }, null, 8, ["class", "name"])],
          2
          /* CLASS */
        )]),
        _: 1
        /* STABLE */
      })) : createCommentVNode("v-if", true), createTextVNode(), createVNode(_component_i_flex_item, { class: "message-box__content", grow: "", align: "center" }, {
...
var _sfc_main$q = defineComponent({ name: "FForm", components: { FMessageBox, FErrorList }, provide() {
  ...
  */
  ...
  if (messageBoxError) {
    focus$1(messageBoxError, { scrollToTop: this.needsErrorScroll });
  }
  ...
  if (element) {
    focus$1(element, { scrollToTop: this.needsErrorScroll });
  } else if (invalidElement) {
    focus$1(invalidElement, { force: true, scrollToTop: this.needsErrorScroll });
  }
}, async onSubmit(event) {
  event.preventDefault();
  const components = Object.values(this.components);
  ...
  const reference = new Reference({ id: event.detail.elementId, focusElementId: event.detail.focusElementId, title: event.detail.errorMessage, isValid: event.detail.isValid, numberOfTimesSubmitted: this.numberOfTimesSubmitted });
...
function _sfc_render$q(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("form", mergeProps({ id: _ctx.id, class: "form", novalidate: "" }, _ctx.attrs, { onComponentValidity: _cache[0] || (_cache[0] = (...args) => _ctx.onComponentValidity && _ctx.onComponentValidity(...args)) }), [_ctx.displayError && _ctx.isSubmitted && _ctx.hasError ? (openBlock(), createBlock(_component_f_message_box, { key: 0, tabindex: "-1", type: "error" }, {
    default: withCtx(() => [renderSlot(_ctx.$slots, "error-message", normalizeProps(guardReactiveProps({ slotClass: _ctx.errorMessageSlotClass }))), createTextVNode(), createElementVNode("nav", null, [createVNode(_component_f_error_list, { items: _ctx.componentsWithErrors }, null, 8, ["items"])])]),
    _: 3
    /* FORWARDED */
  })) : createCommentVNode("v-if", true), createTextVNode(), renderSlot(_ctx.$slots, "default")], 16, _hoisted_1$o);
}
var FForm = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$q]]);
var _sfc_main$p = defineComponent({ name: "FFormStep", components: { FIcon, FValidationGroup, FErrorList }, mixins: [TranslationMixin], inheritAttrs: false, props: {
  /**
...
function _sfc_render$p(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_f_error_list = resolveComponent("f-error-list");
  const _component_f_validation_group = resolveComponent("f-validation-group");
  return openBlock(), createBlock(_component_f_validation_group, mergeProps({ id: _ctx.id }, _ctx.attrs, { key: _ctx.validationGroupKey, modelValue: _ctx.groupValidity, "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.groupValidity = $event), class: "form-step", "stop-propagation": true }), {
    default: withCtx(() => [createElementVNode("div", _hoisted_1$n, [renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({ slotClass: _ctx.headerSlotClass, ..._ctx.self.ref, toggleIsOpen: _ctx.toggleIsOpen }))), createTextVNode(), _ctx.self.ref.isValid ? (openBlock(), createBlock(_component_f_icon, { key: 0, class: "form-step__check", name: "success" })) : createCommentVNode("v-if", true)]), createTextVNode(), _ctx.displayErrorList ? (openBlock(), createElementBlock("div", { key: 0, id: _ctx.stepErrorId, class: "form-step__error", tabindex: "-1", role: "group" }, [createElementVNode("nav", null, [createVNode(_component_f_error_list, { bullets: true, items: _ctx.componentsWithError, "before-navigate": _ctx.beforeNavigateToError }, {
      title: withCtx(() => [renderSlot(_ctx.$slots, "error-message", {}, () => [createTextVNode(
        toDisplayString(_ctx.defaultErrorMessage),
        1
        /* TEXT */
      )])]),
      _: 3
      /* FORWARDED */
    }, 8, ["items", "before-navigate"])])], 8, _hoisted_2$j)) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode(
      "div",
      { onComponentValidity: _cache[0] || (_cache[0] = (...args) => _ctx.onComponentValidity && _ctx.onComponentValidity(...args)) },
      [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({ ..._ctx.self.ref, isSubmitted: _ctx.isSubmitted, toggleIsOpen: _ctx.toggleIsOpen }))), createTextVNode(), _ctx.hasArrow ? (openBlock(), createElementBlock("span", _hoisted_3$g)) : createCommentVNode("v-if", true)],
      32
      /* NEED_HYDRATION */
    )]),
    _: 3
...
var _sfc_main$o = defineComponent({ name: "FFormStepButton", components: { FIcon }, mixins: [TranslationMixin], inheritAttrs: false, model: { prop: "sr-only" }, props: {
  /**
...
function _sfc_render$o(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("button", mergeProps({ id: _ctx.id, class: "button button--margin-bottom-0 button--large", type: "button" }, _ctx.$attrs, { "aria-expanded": _ctx.isOpen ? "true" : "false", "data-form-step-button": "" }), [_ctx.isOpen ? (openBlock(), createElementBlock(
    Fragment,
    { key: 0 },
    [createVNode(_component_f_icon, { name: "success", class: "button__icon" }), createTextVNode(
      " " + toDisplayString(_ctx.$t("fkui.form-step-button.close", "OK")),
      1
      /* TEXT */
    )],
    64
    ...
    Fragment,
    { key: 1 },
    [createVNode(_component_f_icon, { name: "pen", class: "button__icon" }), createTextVNode(
      " " + toDisplayString(_ctx.isAnyFieldTouched ? _ctx.$t("fkui.form-step-button.edit", "\xC4ndra") : _ctx.$t("fkui.form-step-button.open", "Fyll i")),
      1
      /* TEXT */
    )],
    64
    ...
    "span",
    _hoisted_2$i,
    toDisplayString(_ctx.additionalScreenreaderText),
    1
    /* TEXT */
  )], 16, _hoisted_1$m);
}
var FFormStepButton = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$o]]);
var _sfc_main$n = defineComponent({ name: "FCard", data() {
...
function _sfc_render$n(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$l, [_ctx.hasHeaderSlot ? (openBlock(), createElementBlock("div", _hoisted_2$h, [renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({ headingSlotClass: _ctx.headingClass })))])) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode("div", _hoisted_3$f, [renderSlot(_ctx.$slots, "default")]), createTextVNode(), _ctx.hasFooterSlot ? (openBlock(), createElementBlock("div", _hoisted_4$c, [renderSlot(_ctx.$slots, "footer")])) : createCommentVNode("v-if", true)]);
}
var FCard = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render$n]]);
var _sfc_main$m = defineComponent({ name: "FLayoutApplicationTemplate", computed: { showHeader() {
...
function _sfc_render$m(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$k, [_ctx.showHeader || _ctx.showTopNavigation ? (openBlock(), createElementBlock(
    "header",
    _hoisted_2$g,
    [_ctx.showHeader ? renderSlot(_ctx.$slots, "header", { key: 0 }) : createCommentVNode("v-if", true), createTextVNode(), _ctx.showTopNavigation ? (openBlock(), createElementBlock("nav", _hoisted_3$e, [renderSlot(_ctx.$slots, "top-navigation")])) : createCommentVNode("v-if", true)],
    512
    /* NEED_PATCH */
  )) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode(
    "main",
    _hoisted_4$b,
    [renderSlot(_ctx.$slots, "default"), createTextVNode(), _ctx.showFooter ? (openBlock(), createElementBlock("footer", _hoisted_5$b, [renderSlot(_ctx.$slots, "footer")])) : createCommentVNode("v-if", true)],
    512
    /* NEED_PATCH */
  )]);
}
...
var _sfc_main$l = defineComponent({ name: "FLayoutLeftPanel", components: { FIcon }, props: {
  /**
...
var _hoisted_4$a = /* @__PURE__ */ createElementVNode(
  "span",
  { class: "sr-only" },
...
var _hoisted_5$a = /* @__PURE__ */ createElementVNode(
  "div",
  null,
...
var _hoisted_7$6 = /* @__PURE__ */ createElementVNode(
  "span",
  { class: "sr-only" },
...
var _hoisted_8$5 = /* @__PURE__ */ createElementVNode(
  "div",
...
var _hoisted_9$4 = /* @__PURE__ */ createElementVNode(
  "div",
  { class: "layout-navigation__navigation__border__dot" },
  null,
  -1
...
var _hoisted_10$4 = /* @__PURE__ */ createElementVNode(
  "div",
  { class: "layout-navigation__navigation__border__dot" },
  null,
  -1
...
function _sfc_render$l(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$j, [createElementVNode("nav", { id: "layout-navigation__navigation", class: "layout-navigation__navigation", style: normalizeStyle(_ctx.navigationStyle), "aria-expanded": _ctx.isOpen }, [createElementVNode("div", _hoisted_3$d, [_ctx.isOpen ? (openBlock(), createElementBlock(
    Fragment,
    { key: 0 },
    [createElementVNode(
      "div",
      { class: "layout-navigation__navigation__inner__title", style: normalizeStyle(_ctx.contentStyle) },
      [renderSlot(_ctx.$slots, "heading"), createTextVNode(), createElementVNode(
        "button",
        ...
        [_hoisted_4$a, createTextVNode(), createVNode(_component_f_icon, { class: "button__icon", name: "chevrons-left" })],
        512
        /* NEED_PATCH */
      )],
      4
      /* STYLE */
    ), createTextVNode(), _hoisted_5$a, createTextVNode(), createElementVNode(
      "div",
      { class: normalizeClass(["layout-navigation__navigation__inner__content scroll-target", _ctx.gridClasses]), style: normalizeStyle(_ctx.contentStyle) },
      [renderSlot(_ctx.$slots, "content")],
      6
      /* CLASS, STYLE */
    )],
    64
    /* STABLE_FRAGMENT */
  )) : createCommentVNode("v-if", true), createTextVNode(), !_ctx.isOpen ? (openBlock(), createElementBlock("div", _hoisted_6$7, [createElementVNode(
    "button",
    ...
    [_hoisted_7$6, createTextVNode(), createVNode(_component_f_icon, { class: "button__icon", name: "bars" })],
    512
    /* NEED_PATCH */
  )])) : createCommentVNode("v-if", true)]), createTextVNode(), _ctx.isOpen ? (openBlock(), createElementBlock(
    "div",
    ...
    [_hoisted_8$5, createTextVNode(), _hoisted_9$4, createTextVNode(), _hoisted_10$4],
    32
    /* NEED_HYDRATION */
  )) : createCommentVNode("v-if", true)], 12, _hoisted_2$f), createTextVNode(), createElementVNode(
    "div",
    { id: "layout-navigation__primary", class: normalizeClass(["layout-navigation__primary", _ctx.leftPrimaryClasses]), style: normalizeStyle(_ctx.primaryStyle) },
    [renderSlot(_ctx.$slots, "default")],
    6
    /* CLASS, STYLE */
  )]);
...
var _sfc_main$k = defineComponent({ name: "FLayoutRightPanel", components: { FIcon }, props: {
  /**
  * The default width for the panel in pixels
  */
...
var _hoisted_2$e = /* @__PURE__ */ createElementVNode(
  "div",
...
var _hoisted_3$c = /* @__PURE__ */ createElementVNode(
  "div",
  { class: "layout-secondary__secondary__border__dot" },
  null,
  -1
...
var _hoisted_4$9 = /* @__PURE__ */ createElementVNode(
  "div",
  { class: "layout-secondary__secondary__border__dot" },
  null,
  -1
...
var _hoisted_6$6 = /* @__PURE__ */ createElementVNode(
  "div",
  null,
  [/* @__PURE__ */ createElementVNode("hr", { "aria-hidden": "true" })],
  -1
  /* HOISTED */
);
var _hoisted_7$5 = /* @__PURE__ */ createElementVNode(
  "span",
  { class: "sr-only" },
...
function _sfc_render$k(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$i, [createElementVNode(
    "div",
    { id: "layout-secondary__primary", class: normalizeClass(["layout-secondary__primary", _ctx.rightPrimaryClasses]), style: normalizeStyle(_ctx.primaryStyle) },
    [renderSlot(_ctx.$slots, "default")],
    6
    /* CLASS, STYLE */
  ), createTextVNode(), _ctx.isOpen ? (openBlock(), createElementBlock(
    "aside",
    { key: 0, style: normalizeStyle(_ctx.secondaryStyle), class: "layout-secondary__secondary" },
    [createElementVNode(
      "div",
      ...
      [_hoisted_2$e, createTextVNode(), _hoisted_3$c, createTextVNode(), _hoisted_4$9],
      32
      /* NEED_HYDRATION */
    ), createTextVNode(), createElementVNode("div", _hoisted_5$9, [createElementVNode(
      "div",
      { ref: "title", class: "layout-secondary__secondary__inner__title", style: normalizeStyle(_ctx.contentStyle) },
      [renderSlot(_ctx.$slots, "heading")],
      4
      /* STYLE */
    ), createTextVNode(), _hoisted_6$6, createTextVNode(), createElementVNode(
      "div",
      { class: normalizeClass(["layout-secondary__secondary__inner__content scroll-target", _ctx.gridClasses]), style: normalizeStyle(_ctx.contentStyle) },
      [renderSlot(_ctx.$slots, "content"), createTextVNode(), createElementVNode("button", { class: "button button--tertiary button--small button--tertiary--black layout-secondary__secondary__inner__close", type: "button", onClick: _cache[1] || (_cache[1] = (...args) => _ctx.onClickCloseSecondary && _ctx.onClickCloseSecondary(...args)) }, [_hoisted_7$5, createTextVNode(), createVNode(_component_f_icon, { class: "button__icon", name: "close" })])],
      6
      /* CLASS, STYLE */
    )])],
    4
...
var _sfc_main$j = defineComponent({ name: "FList", components: { FCheckboxField }, mixins: [TranslationMixin], props: {
  /**
  ...
  */
  elementId: { type: String, default: () => ElementIdService.generateElementId() }
...
function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.selectable ? (openBlock(), createElementBlock("ul", _hoisted_1$h, [(openBlock(true), createElementBlock(
    Fragment,
    null,
    renderList(_ctx.items, (item) => {
      return openBlock(), createElementBlock("li", { key: _ctx.itemKey(item), class: "list__item" }, [createElementVNode(
        "div",
    ...
    128
    /* KEYED_FRAGMENT */
  )), createTextVNode(), _ctx.isEmpty ? (openBlock(), createElementBlock("li", _hoisted_2$d, [createElementVNode("div", _hoisted_3$b, [renderSlot(_ctx.$slots, "empty", {}, () => [createElementVNode(
    "em",
    null,
    toDisplayString(_ctx.$t("fkui.list.empty", "Listan \xE4r tom")),
    1
    /* TEXT */
  )])])])) : createCommentVNode("v-if", true)])) : (openBlock(), createElementBlock("ul", { key: 1, ref: "ulElement", class: "list list--hover", tabindex: _ctx.checkbox ? 0 : void 0 }, [(openBlock(true), createElementBlock(
    Fragment,
    null,
    renderList(_ctx.items, (item, index) => {
      return openBlock(), createElementBlock("li", { id: _ctx.getItemId(item), key: _ctx.itemKey(item), "aria-labelledby": _ctx.getItemId(item), class: normalizeClass([_ctx.itemClasses(item), "list__item"]), tabindex: _ctx.checkbox ? 0 : void 0, onKeydown: withModifiers(($event) => _ctx.onItemKeyDown($event, item), ["self"]), onFocus: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.onItemFocus && _ctx.onItemFocus(...args), ["self"])), onBlur: _cache[1] || (_cache[1] = withModifiers((...args) => _ctx.onItemBlur && _ctx.onItemBlur(...args), ["self"])) }, [_ctx.checkbox ? (openBlock(), createElementBlock("div", { key: 0, class: "list__item__selectpane", onClick: withModifiers(($event) => _ctx.onSelect(item), ["self"]) }, [createElementVNode("div", _hoisted_7$4, [createVNode(_component_f_checkbox_field, { value: true, "model-value": _ctx.isSelected(item), onClick: withModifiers(($event) => _ctx.onSelect(item), ["self"]) }, {
        default: withCtx(() => [createElementVNode("span", { id: _ctx.getAriaLabelledbyId(item), class: "sr-only" }, [renderSlot(_ctx.$slots, "screenreader", mergeProps({ ref_for: true }, { item }))], 8, _hoisted_8$4)]),
        _: 2
        /* DYNAMIC */
      }, 1032, ["model-value", "onClick"])])], 8, _hoisted_6$5)) : createCommentVNode("v-if", true), createTextVNode(), (openBlock(), createBlock(resolveDynamicComponent(_ctx.checkbox ? "div" : "a"), { ref_for: true, ref: "listItemPanes", href: !_ctx.checkbox ? "javascript:" : void 0, class: "list__item__itempane", onClick: ($event) => _ctx.onItemClick($event, index, item) }, {
    ...
    128
    /* KEYED_FRAGMENT */
  )), createTextVNode(), _ctx.isEmpty ? (openBlock(), createElementBlock("li", _hoisted_9$3, [createElementVNode("div", _hoisted_10$3, [renderSlot(_ctx.$slots, "empty", {}, () => [createElementVNode(
    "em",
    null,
    toDisplayString(_ctx.$t("fkui.list.empty", "Listan \xE4r tom")),
    1
    /* TEXT */
  )])])])) : createCommentVNode("v-if", true)], 8, _hoisted_4$8));
}
var FList = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$j]]);
var _sfc_main$i = defineComponent({ name: "FLoader", mixins: [TranslationMixin], inheritAttrs: false, props: {
...
var _sfc_main$h = defineComponent({ name: "IPopupMenu", components: { FIcon, IPopup }, props: {
  /**
...
function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  const _component_i_popup = resolveComponent("i-popup");
  return openBlock(), createBlock(_component_i_popup, { class: "ipopupmenu", "is-open": _ctx.isOpen, "keyboard-trap": false, anchor: _ctx.anchor, "focus-element": _ctx.focusElement, onClose: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("close")), onKeyup: _ctx.onKeyUp, onKeydown: _ctx.onKeyDown }, {
    default: withCtx(() => [createElementVNode("nav", { class: "ipopupmenu ipopupmenu--vertical", "aria-label": _ctx.ariaLabel }, [createElementVNode("ul", _hoisted_2$b, [(openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.items, (item, index) => {
        return openBlock(), createElementBlock("li", { ref_for: true, ref: "items", key: item.key, role: "presentation", class: normalizeClass(_ctx.itemClasses(item)), onClick: ($event) => _ctx.onClickItem(item) }, [createElementVNode("a", { ref_for: true, ref: "anchors", "data-ref-index": index, href: item.href, role: "menuitem", target: item.target, tabindex: "0" }, [_ctx.isSelected(index) ? (openBlock(), createElementBlock("span", _hoisted_5$7, [createElementVNode(
          "span",
          null,
          toDisplayString(_ctx.selectedMenuItemScreenReaderText) + "\xA0",
          1
          /* TEXT */
          ...
          1
          /* TEXT */
        ), item.iconRight ? (openBlock(), createBlock(_component_f_icon, { key: 1, name: item.iconRight }, null, 8, ["name"])) : createCommentVNode("v-if", true)], 8, _hoisted_4$7)], 10, _hoisted_3$9);
      }),
      128
      /* KEYED_FRAGMENT */
    ))])], 8, _hoisted_1$f)]),
...
var _sfc_main$g = defineComponent({ name: "IMenu", components: { FIcon }, props: {
  /**
...
function _sfc_render$g(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    "nav",
    { class: normalizeClass(["imenu", _ctx.cssClasses]), "aria-label": "Navigeringsmeny", onKeyup: _cache[0] || (_cache[0] = (...args) => _ctx.onKeyUp && _ctx.onKeyUp(...args)), onKeydown: _cache[1] || (_cache[1] = (...args) => _ctx.onKeyDown && _ctx.onKeyDown(...args)) },
    [createElementVNode("ul", _hoisted_1$e, [(openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.items, (item, index) => {
        return openBlock(), createElementBlock("li", { ref_for: true, ref: "items", key: item.key, "data-ref-index": index, class: normalizeClass(["imenu__list__item", _ctx.cssClassHighlight(item)]), role: "none", onClick: ($event) => _ctx.onClickItem(item) }, [createElementVNode(
          "div",
          { class: normalizeClass([_ctx.ccsClassHighlightAnchorContainer(item), "imenu__list__anchor-container"]) },
          [createElementVNode("a", { ref_for: true, ref: "anchors", "data-ref-index": index, tabindex: "0", href: item.href, target: item.target, class: normalizeClass(["imenu__list__anchor", _ctx.ccsClassHighlightAnchor(item)]), role: "menuitem", "aria-haspopup": _ctx.ariaHasPopup(index) }, [_ctx.isSelected(index) ? (openBlock(), createElementBlock("span", _hoisted_4$6, [createElementVNode(
            "span",
            null,
            toDisplayString(_ctx.getSelectedMenuItemScreenReaderText(index)) + "\xA0",
            1
            /* TEXT */
          )])) : createCommentVNode("v-if", true), createTextVNode(
            toDisplayString(item.label),
            1
            /* TEXT */
          ), item.iconRight ? (openBlock(), createElementBlock("span", _hoisted_5$6)) : createCommentVNode("v-if", true), createTextVNode(), item.iconRight ? (openBlock(), createBlock(_component_f_icon, { key: 2, name: item.iconRight, class: "imenu__list__anchor-icon-right" }, null, 8, ["name"])) : createCommentVNode("v-if", true)], 10, _hoisted_3$8)],
          2
          /* CLASS */
        )], 10, _hoisted_2$a);
      }),
...
var _sfc_main$f = defineComponent({ name: "FNavigationMenu", components: { IMenu, IPopupMenu }, mixins: [TranslationMixin], props: {
  /** Current route.
  * @model
  */
...
function _sfc_render$f(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_i_menu = resolveComponent("i-menu");
...
var _sfc_main$e = defineComponent({ name: "FOffline", components: { FIcon, IFlex, IFlexItem }, data() {
...
function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_i_flex_item = resolveComponent("i-flex-item");
  const _component_i_flex = resolveComponent("i-flex");
  return openBlock(), createElementBlock("div", { ref: "offline", class: "offline__wrapper", role: _ctx.role }, [!_ctx.isOnline ? (openBlock(), createElementBlock("div", _hoisted_2$9, [createVNode(_component_i_flex, { gap: "2x" }, {
    default: withCtx(() => [createVNode(_component_i_flex_item, { class: "offline__icon", shrink: "", align: "center" }, {
      default: withCtx(() => [createElementVNode("span", _hoisted_3$7, [createVNode(_component_f_icon, { name: "triangle" }), createTextVNode(), createVNode(_component_f_icon, { name: "alert" })])]),
      _: 1
      /* STABLE */
    }), createTextVNode(), createVNode(_component_i_flex_item, { class: "offline_content", grow: "", align: "center" }, {
      default: withCtx(() => [createElementVNode("p", _hoisted_4$5, [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(" Det verkar som att du inte har n\xE5gon internetuppkoppling just nu ")])])]),
      _: 3
      /* FORWARDED */
    })]),
    _: 3
    /* FORWARDED */
  })])) : createCommentVNode("v-if", true), createTextVNode(), withDirectives(createElementVNode("span", { class: "sr-only", "aria-hidden": _ctx.shouldNotRead ? "true" : void 0 }, "\n            Din internetuppkoppling fungerar igen\n        ", 8, _hoisted_5$5), [[vShow, _ctx.isOnline]])], 8, _hoisted_1$d);
}
var FOffline = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$e]]);
var _sfc_main$d = defineComponent({ name: "FOutputField", components: { FLabel }, inheritAttrs: false, props: {
  /**
...
function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_label = resolveComponent("f-label");
  return openBlock(), createElementBlock("div", _hoisted_1$c, [createVNode(_component_f_label, { for: _ctx.id }, createSlots({
    default: withCtx(() => [renderSlot(_ctx.$slots, "label")]),
    _: 2
    /* DYNAMIC */
  }, [_ctx.$slots.tooltip ? { name: "tooltip", fn: withCtx(() => [renderSlot(_ctx.$slots, "tooltip")]), key: "0" } : void 0]), 1032, ["for"]), createTextVNode(), createElementVNode("output", mergeProps({ id: _ctx.id, for: _ctx.htmlFor, class: "output-field__output" }, _ctx.$attrs), [renderSlot(_ctx.$slots, "default")], 16, _hoisted_2$8)]);
}
var FOutputField = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$d]]);
var _sfc_main$c = defineComponent({ name: "ISkipLink", mixins: [TranslationMixin], props: {
  /**
  * Target for skiplink.
  */
...
function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("a", { class: "iskiplink", href: _ctx.href }, [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(
    toDisplayString(_ctx.$t("fkui.skip-link.text", "G\xE5 direkt till inneh\xE5ll")),
    1
    /* TEXT */
  )])], 8, _hoisted_1$b);
}
...
var _sfc_main$b = defineComponent({ name: "FPageHeader", components: { ISkipLink }, mixins: [TranslationMixin], inheritAttrs: true, props: {
...
function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$a, [_ctx.skipLinkAnchor ? (openBlock(), createElementBlock("nav", _hoisted_2$7, [createVNode(_component_i_skip_link, { href: _ctx.skipLinkAnchor }, {
    default: withCtx(() => [renderSlot(_ctx.$slots, "skip-link-text")]),
    _: 3
    /* FORWARDED */
  }, 8, ["href"])])) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode(
    "div",
    _hoisted_3$6,
    [createElementVNode("div", _hoisted_4$4, [renderSlot(_ctx.$slots, "logo", {}, () => [_ctx.routerLinkTo ? (openBlock(), createBlock(_component_router_link, { key: 0, to: _ctx.routerLinkTo }, {
      default: withCtx(() => [createElementVNode("span", { class: normalizeClass(_ctx.logoClass), "aria-label": _ctx.altLogoText, role: "img" }, null, 10, _hoisted_5$4)]),
      _: 1
      /* STABLE */
    }, 8, ["to"])) : (openBlock(), createElementBlock("span", { key: 1, class: normalizeClass(_ctx.logoClass), "aria-label": _ctx.altLogoText, role: "img" }, null, 10, _hoisted_6$4))])]), createTextVNode(), (openBlock(), createBlock(resolveDynamicComponent(_ctx.headerTag), { class: "page-header__app-name" }, {
      default: withCtx(() => [renderSlot(_ctx.$slots, "default")]),
      _: 3
      /* FORWARDED */
    })), createTextVNode(), createElementVNode("div", _hoisted_7$3, [createElementVNode("div", _hoisted_8$3, [renderSlot(_ctx.$slots, "right")])])],
    512
    /* NEED_PATCH */
  )]);
}
...
var _sfc_main$a = defineComponent({ name: "FProgressbar", props: {
  /**
...
function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$9, [createElementVNode("span", { class: normalizeClass(["progress__meter", _ctx.progressBarClass]), role: "progressbar", "aria-label": _ctx.ariaLabel, "aria-valuemin": "0", "aria-valuemax": "100", "aria-valuenow": _ctx.progressValueNow, "aria-valuetext": _ctx.progressText, style: normalizeStyle(_ctx.cssWidth) }, [createElementVNode(
    "span",
    _hoisted_3$5,
    toDisplayString(_ctx.progressText),
    1
    /* TEXT */
  )], 14, _hoisted_2$6)]);
}
...
var _sfc_main$9 = defineComponent({ name: "FRadioField", inheritAttrs: false, props: {
  /**
  * Set to `true`, empty string `""` or string `"disabled"` to disable this input field.
  */
  disabled: { type: Boolean, required: false, default: false },
...
var _hoisted_4$3 = /* @__PURE__ */ createElementVNode(
  "br",
  null,
  null,
  -1
...
var _hoisted_6$3 = /* @__PURE__ */ createElementVNode(
  "br",
  null,
  null,
  -1
...
function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    { class: normalizeClass(["radio-button", _ctx.disabledClass]), onValidity: _cache[0] || (_cache[0] = (...args) => _ctx.onValidity && _ctx.onValidity(...args)) },
    [createElementVNode("input", mergeProps({ id: _ctx.id, type: "radio", class: "radio-button__input", disabled: _ctx.disabled }, _ctx.attrs), null, 16, _hoisted_1$8), createTextVNode(), createElementVNode("label", { class: normalizeClass(_ctx.$slots.details ? "radio-button__label radio-button__width" : "radio-button__label"), for: _ctx.id }, [renderSlot(_ctx.$slots, "default"), createTextVNode(), _ctx.$slots.details ? (openBlock(), createElementBlock(
      Fragment,
      { key: 0 },
      [_ctx.showDetails === "always" ? (openBlock(), createElementBlock("span", _hoisted_3$4, [_hoisted_4$3, createTextVNode(), renderSlot(_ctx.$slots, "details")])) : createCommentVNode("v-if", true), createTextVNode(), _ctx.showDetails === "when-selected" ? (openBlock(), createBlock(Transition, { key: 1, onEnter: _ctx.enter, onAfterEnter: _ctx.afterEnter, onLeave: _ctx.leave }, {
        default: withCtx(() => [_ctx.value === _ctx.modelValue ? (openBlock(), createElementBlock("span", _hoisted_5$3, [_hoisted_6$3, createTextVNode(), renderSlot(_ctx.$slots, "details", { height: _ctx.height })])) : createCommentVNode("v-if", true)]),
        _: 3
        /* FORWARDED */
      }, 8, ["onEnter", "onAfterEnter", "onLeave"])) : createCommentVNode("v-if", true)],
      64
      /* STABLE_FRAGMENT */
    )) : createCommentVNode("v-if", true)], 10, _hoisted_2$5)],
    34
    /* CLASS, NEED_HYDRATION */
  );
}
var FRadioField = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9]]);
var _sfc_main$8 = defineComponent({ name: "FRadioGroup", components: { FFieldset }, inheritAttrs: false, props: {
  /**
  * The id for the fieldset id attribute.
  * If the prop is not set the id will be generated.
  */
...
function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_fieldset = resolveComponent("f-fieldset");
  return openBlock(), createBlock(_component_f_fieldset, mergeProps({ id: _ctx.id, name: _ctx.name }, _ctx.$attrs, { horizontal: _ctx.isHorizontal }), createSlots({
    label: withCtx(() => [renderSlot(_ctx.$slots, "label")]),
    description: withCtx(({ descriptionClass, discreteDescriptionClass }) => [renderSlot(_ctx.$slots, "description", normalizeProps(guardReactiveProps({ descriptionClass, discreteDescriptionClass })))]),
    "error-message": withCtx(() => [renderSlot(_ctx.$slots, "error-message")]),
    default: withCtx(() => [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({ indentClass: "indent" })))]),
    _: 2
    /* DYNAMIC */
  }, [_ctx.$slots.tooltip ? { name: "tooltip", fn: withCtx(() => [renderSlot(_ctx.$slots, "tooltip")]), key: "0" } : void 0]), 1040, ["id", "name", "horizontal"]);
}
var FRadioGroup = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$8]]);
var _sfc_main$7 = defineComponent({ name: "FStaticField", components: { FLabel } });
var _hoisted_1$7 = { class: "output-field" };
var _hoisted_2$4 = { class: "output-field__output" };
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_label = resolveComponent("f-label");
  return openBlock(), createElementBlock("div", _hoisted_1$7, [createVNode(
    _component_f_label,
    null,
    createSlots({
      default: withCtx(() => [renderSlot(_ctx.$slots, "label")]),
      ...
      _: 2
      /* DYNAMIC */
    }, [_ctx.$slots.tooltip ? { name: "tooltip", fn: withCtx(() => [renderSlot(_ctx.$slots, "tooltip")]), key: "0" } : void 0]),
    1024
    /* DYNAMIC_SLOTS */
  ), createTextVNode(), createElementVNode("p", _hoisted_2$4, [renderSlot(_ctx.$slots, "default")])]);
}
...
var _sfc_main$6 = defineComponent({ name: "FInteractiveTable", components: { FCheckboxField, FIcon }, mixins: [TranslationMixin], provide() {
  return { addColumn: (column) => {
    this.columns = addColumn(this.columns, column);
  }, setVisibilityColumn: (id, visible) => {
    setVisibilityColumn(this.columns, id, visible);
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [createElementVNode("table", mergeProps({ class: ["table", _ctx.tableClasses], role: _ctx.tableRole }, _ctx.$attrs), [_ctx.hasCaption ? (openBlock(), createElementBlock("caption", _hoisted_2$3, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode("colgroup", null, [_ctx.isExpandableTable ? (openBlock(), createElementBlock("col", _hoisted_3$3)) : createCommentVNode("v-if", true), createTextVNode(), _ctx.selectable ? (openBlock(), createElementBlock("col", _hoisted_4$2)) : createCommentVNode("v-if", true), createTextVNode(), (openBlock(true), createElementBlock(
      ...
      128
      /* KEYED_FRAGMENT */
    ))]), createTextVNode(), createElementVNode("thead", null, [createElementVNode("tr", _hoisted_5$2, [_ctx.isExpandableTable ? (openBlock(), createElementBlock("th", _hoisted_6$2, [createElementVNode(
      "span",
      _hoisted_7$2,
      toDisplayString(_ctx.$t("fkui.interactive-table.select", "Expandera")),
      1
      /* TEXT */
    )])) : createCommentVNode("v-if", true), createTextVNode(), _ctx.selectable ? (openBlock(), createElementBlock("th", _hoisted_8$2, [createElementVNode(
      "span",
      _hoisted_9$2,
      toDisplayString(_ctx.$t("fkui.interactive-table.select", "Markera")),
      1
      /* TEXT */
    )])) : createCommentVNode("v-if", true), createTextVNode(), (openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList(_ctx.visibleColumns, (column) => {
        return openBlock(), createElementBlock(
          "th",
          mergeProps({ key: column.id, scope: "col", class: _ctx.columnClasses(column) }, toHandlers(column.sortable ? { click: () => _ctx.onClickColumnHeader(column) } : {}, true)),
          [createElementVNode("span", { innerHTML: _ctx.escapeNewlines(column.title) }, null, 8, _hoisted_10$2), createTextVNode(), column.sortable ? (openBlock(), createBlock(_component_f_icon, { key: 0, class: normalizeClass(_ctx.iconClasses(column)), name: _ctx.iconName(column) }, null, 8, ["class", "name"])) : createCommentVNode("v-if", true), createTextVNode(), column.description ? (openBlock(), createElementBlock(
            "span",
            _hoisted_11$1,
            toDisplayString(column.description),
            1
      ...
      [(openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList(_ctx.rows, (row, index) => {
          return openBlock(), createElementBlock(
            Fragment,
            { key: _ctx.rowKey(row) },
            [createElementVNode("tr", { class: normalizeClass(_ctx.rowClasses(row, index)), "aria-label": _ctx.rowDescription(row), "aria-expanded": _ctx.rowAriaExpanded(row), "aria-level": _ctx.isExpandableTable ? 1 : void 0, "aria-describedby": _ctx.getExpandableDescribedby(row), tabindex: "0", onKeydown: withModifiers(($event) => _ctx.onKeydown($event, index), ["self"]), onClick: ($event) => _ctx.onClick($event, row, index) }, [_ctx.isExpandableTable ? (openBlock(), createElementBlock("td", _hoisted_14$1, [_ctx.hasExpandableContent(row) ? (openBlock(), createElementBlock("div", _hoisted_15$1, [createVNode(_component_f_icon, { name: "arrow-right", rotate: _ctx.isExpanded(row) ? "270" : "90" }, null, 8, ["rotate"])])) : createCommentVNode("v-if", true)])) : createCommentVNode("v-if", true), createTextVNode(), _ctx.selectable ? (openBlock(), createElementBlock("td", _hoisted_16, [createElementVNode("div", _hoisted_17, [createVNode(_component_f_checkbox_field, { value: true, "model-value": _ctx.isSelected(row), onClick: withModifiers(($event) => _ctx.onSelect(row), ["self"]) }, {
              default: withCtx(() => [_ctx.hasCheckboxDescription ? (openBlock(), createElementBlock("span", _hoisted_18, [renderSlot(_ctx.$slots, "checkbox-description", mergeProps({ ref_for: true }, { row }))])) : createCommentVNode("v-if", true)]),
              _: 2
              /* DYNAMIC */
            }, 1032, ["model-value", "onClick"])])])) : createCommentVNode("v-if", true), createTextVNode(), renderSlot(_ctx.$slots, "default", mergeProps({ ref_for: true }, { row }))], 42, _hoisted_13$1), createTextVNode(), _ctx.isExpandableTable && _ctx.hasExpandableContent(row) ? (openBlock(true), createElementBlock(
              Fragment,
              { key: 0 },
              renderList(_ctx.expandableRows(row), (expandableRow, expandableIndex) => {
                return openBlock(), createElementBlock(
                  "tr",
                  { key: _ctx.rowKey(expandableRow), "aria-level": "2", class: normalizeClass(_ctx.expandableRowClasses(row, expandableIndex)) },
                  [_hoisted_19, createTextVNode(), _ctx.selectable ? (openBlock(), createElementBlock("td", _hoisted_20)) : createCommentVNode("v-if", true), createTextVNode(), !_ctx.hasExpandableSlot ? (openBlock(true), createElementBlock(
                    Fragment,
                    { key: 1 },
                    renderList(_ctx.columns, (column, columnIndex) => {
                      return openBlock(), createElementBlock(
                        "td",
                        { key: `${_ctx.rowKey(expandableRow)}${column.name}`, class: normalizeClass(_ctx.expandableColumnClasses(column, columnIndex)) },
                        toDisplayString(expandableRow[column.name]),
                        3
                        /* TEXT, CLASS */
                      );
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  )) : (openBlock(), createElementBlock("td", { key: 2, class: "table__column table__column--indented", colspan: _ctx.columns.length }, [renderSlot(_ctx.$slots, "expandable", mergeProps({ ref_for: true }, { expandableRow, parentRow: row }))], 8, _hoisted_21))],
                  2
                  /* CLASS */
                );
              }),
        ...
        128
        /* KEYED_FRAGMENT */
      )), createTextVNode(), _ctx.isEmpty && _ctx.columns.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_22, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({ row: {} })))])) : createCommentVNode("v-if", true), createTextVNode(), _ctx.isEmpty ? (openBlock(), createElementBlock("tr", _hoisted_23, [createElementVNode("td", { class: "table__column table__column--action", colspan: _ctx.nbOfColumns }, [renderSlot(_ctx.$slots, "empty", {}, () => [createTextVNode(
        toDisplayString(_ctx.$t("fkui.interactive-table.empty", "Tabellen \xE4r tom")),
        1
        /* TEXT */
...
var _sfc_main$5 = defineComponent({ name: "FTextareaField", components: { FLabel }, inheritAttrs: false, props: {
  /**
  * The id for the input id attribute.
  * The id for the label for attribute.
  * If the prop is not set a random value will be generated.
...
function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [createVNode(_component_f_label, { for: _ctx.id }, createSlots({
      ...
      _: 2
      /* DYNAMIC */
    }, [_ctx.$slots.tooltip ? { name: "tooltip", fn: withCtx(() => [renderSlot(_ctx.$slots, "tooltip")]), key: "0" } : void 0]), 1032, ["for"]), createTextVNode(), _ctx.softLimit ? (openBlock(), createBlock(_component_f_label, { key: 0, for: _ctx.id, "aria-live": "polite" }, {
      description: withCtx(({ descriptionClass }) => [_ctx.showCharactersLeftWarning ? (openBlock(), createElementBlock(
        "span",
        { key: 0, class: normalizeClass(descriptionClass) },
        toDisplayString(_ctx.charactersLeftWarningInterpolated),
        3
        /* TEXT, CLASS */
      )) : createCommentVNode("v-if", true)]),
      _: 1
      /* STABLE */
    }, 8, ["for"])) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode("textarea", mergeProps({ id: _ctx.id, class: _ctx.textareaClass }, _ctx.attrs, { disabled: _ctx.disabled, onInput: _cache[0] || (_cache[0] = (...args) => _ctx.onInput && _ctx.onInput(...args)), onValidity: _cache[1] || (_cache[1] = (...args) => _ctx.onValidity && _ctx.onValidity(...args)), onPendingValidity: _cache[2] || (_cache[2] = (...args) => _ctx.onPendingValidity && _ctx.onPendingValidity(...args)) }), null, 16, _hoisted_1$5)],
    2
    /* CLASS */
  );
}
...
var _sfc_main$4 = defineComponent({ name: "IAnimateExpand", props: {
  /**
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    { class: normalizeClass(_ctx.animationClasses), style: normalizeStyle(_ctx.heightStyle) },
    [_ctx.shouldVIf ? withDirectives((openBlock(), createElementBlock(
      "div",
      _hoisted_1$4,
      [renderSlot(_ctx.$slots, "default")],
      512
      /* NEED_PATCH */
    )), [[vShow, _ctx.shouldVShow]]) : createCommentVNode("v-if", true)],
    6
    /* CLASS, STYLE */
  );
}
var IAnimateExpand = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4]]);
var _sfc_main$3 = defineComponent({ name: "FTooltip", components: { FExpand, FIcon, IFlex, IFlexItem }, props: {
  /**
  ...
  * Close button text
  */
  closeButtonText: { type: String, required: false, default: TranslationService.provider.translate("fkui.tooltip.close", "St\xE4ng") },
  /**
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_i_flex = resolveComponent("i-flex");
  const _component_f_expand = resolveComponent("f-expand");
  return openBlock(), createElementBlock("div", _hoisted_1$3, [createElementVNode("div", _hoisted_2$2, [createElementVNode("button", { class: "tooltip__button", type: "button", "aria-expanded": _ctx.isOpen ? "true" : "false", onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClickToggle && _ctx.onClickToggle(...args)) }, [createElementVNode("span", _hoisted_4$1, [createVNode(_component_f_icon, { name: "circle" }), createTextVNode(), createVNode(_component_f_icon, { name: "i" }), createTextVNode(), createElementVNode(
    "span",
    _hoisted_5$1,
    toDisplayString(_ctx.screenReaderText),
    1
    /* TEXT */
  )])], 8, _hoisted_3$2), createTextVNode(), createVNode(_component_f_expand, null, {
    default: withCtx(() => [_ctx.isOpen ? (openBlock(), createElementBlock("div", _hoisted_6$1, [createElementVNode("div", { class: "tooltip__content-wrapper", tabindex: "-1", "aria-hidden": _ctx.isOpen ? void 0 : "true" }, [withDirectives(createElementVNode(
      "span",
      _hoisted_8$1,
      null,
      512
      /* NEED_PATCH */
    ), [[vShow, _ctx.isOpen]]), createTextVNode(), createElementVNode("div", _hoisted_9$1, [_ctx.hasHeader ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.headerTag), { key: 0, class: "tooltip__header" }, {
      default: withCtx(() => [renderSlot(_ctx.$slots, "header")]),
      _: 3
      /* FORWARDED */
    })) : createCommentVNode("v-if", true), createTextVNode(), createElementVNode("div", _hoisted_10$1, [renderSlot(_ctx.$slots, "body")])]), createTextVNode(), createVNode(_component_i_flex, { float: "right" }, {
      default: withCtx(() => [createVNode(_component_i_flex_item, { shrink: "" }, {
        default: withCtx(() => [createElementVNode("button", { class: "close-button", type: "button", onClick: _cache[1] || (_cache[1] = (...args) => _ctx.onClickToggle && _ctx.onClickToggle(...args)) }, [createElementVNode(
          "span",
          null,
          toDisplayString(_ctx.closeButtonText),
          1
          /* TEXT */
        ), createTextVNode(), createVNode(_component_f_icon, { class: "button__icon", name: "close" })])]),
        _: 1
        /* STABLE */
      })]),
      _: 1
      /* STABLE */
    })], 8, _hoisted_7$1)])) : createCommentVNode("v-if", true)]),
    _: 3
    /* FORWARDED */
  })])]);
}
...
function FWizardApiInjected() {
  return { register: inject("register"), unregister: inject("unregister"), getStepCount: inject("getStepCount"), openStep: inject("openStep"), openNext: inject("openNext"), cancel: inject("cancel"), inheritedProps: inject("inheritedProps") };
}
...
var _sfc_main$2 = defineComponent({ name: "FWizard", provide() {
  const wizard = this;
...
var _sfc_main$1 = defineComponent({ name: "FWizardStep", components: { IAnimateExpand, IFlex, IFlexItem, FValidationForm, FIcon }, mixins: [TranslationMixin], inheritAttrs: true, props: {
  title: { type: String, required: true },
  /**
  ...
  async beforeAnimation(open) {
    ...
    if (!open) {
      ...
      if (!DomUtils.isVisibleInViewport(headerElement)) {
        ongoingScrollPromise = DomUtils.scrollTo(headerElement, { duration: SCROLL_DURATION, offset: 10 });
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", { class: normalizeClass(["wizard-step", _ctx.cssClass]), "aria-current": _ctx.isOpen ? "step" : void 0 }, [createElementVNode(
    "div",
    _hoisted_2$1,
    [createVNode(_component_i_flex, null, {
      default: withCtx(() => [createVNode(_component_i_flex_item, { align: "bottom", shrink: "", "aria-hidden": "true" }, {
        default: withCtx(() => [_hoisted_3$1, createTextVNode(), createElementVNode("div", _hoisted_4, [createVNode(_component_f_icon, { name: "circle" }), createTextVNode(), createVNode(_component_f_icon, { name: "success" }), createTextVNode(), createElementVNode(
          "div",
          _hoisted_5,
          toDisplayString(_ctx.stepNumber),
          1
          /* TEXT */
        )]), createTextVNode(), _hoisted_6]),
        _: 1
        /* STABLE */
      }), createTextVNode(), createVNode(_component_i_flex_item, { align: "bottom", grow: "" }, {
        default: withCtx(() => [_ctx.isOpen ? renderSlot(_ctx.$slots, "step-of", normalizeProps(mergeProps({ key: 0 }, { headerClass: "wizard-step__header__step-of", stepNumber: _ctx.stepNumber, totalSteps: _ctx.totalSteps })), () => [createElementVNode(
          "span",
          _hoisted_7,
          toDisplayString(_ctx.defaultCurrentStepInformation),
          1
          /* TEXT */
        )]) : createCommentVNode("v-if", true), createTextVNode(), createVNode(_component_i_flex, { class: "wizard-step__header__title-container" }, {
          default: withCtx(() => [createVNode(_component_i_flex_item, { align: "center" }, {
            default: withCtx(() => [_ctx.showLink ? (openBlock(), createElementBlock(
              "a",
              { key: 0, "aria-expanded": "false", role: "button", href: "#", class: "anchor wizard-step__header__title", onClick: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.open && _ctx.open(...args), ["prevent"])), onKeypress: _cache[1] || (_cache[1] = withKeys(withModifiers((...args) => _ctx.open && _ctx.open(...args), ["prevent"]), ["space"])) },
              [createElementVNode(
                "span",
                _hoisted_8,
                toDisplayString(_ctx.defaultCurrentStepInformation) + "\xA0",
                1
                /* TEXT */
              ), createTextVNode(
                ...
                "span",
                _hoisted_9,
                "\xA0" + toDisplayString(_ctx.$t("fkui.wizard-step.finished-step", "Avklarat steg")),
                1
                /* TEXT */
              )],
              32
              /* NEED_HYDRATION */
            )) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.inheritedProps.headerTag), { key: 1, class: "wizard-step__header__title" }, {
              default: withCtx(() => [createElementVNode(
                "span",
                _hoisted_10,
                toDisplayString(_ctx.defaultCurrentStepInformation) + "\xA0",
                ...
                1
                /* TEXT */
              ), _ctx.isPending ? (openBlock(), createElementBlock(
                "span",
                _hoisted_11,
                "\n                                    \xA0" + toDisplayString(_ctx.$t("fkui.wizard-step.pending", "Inaktivt")),
                1
                /* TEXT */
              )) : createCommentVNode("v-if", true)]),
              _: 1
    ...
    512
    /* NEED_PATCH */
  ), createTextVNode(), (openBlock(), createBlock(_component_i_animate_expand, { key: _ctx.animationId, opacity: false, expanded: _ctx.isOpen, "before-animation": _ctx.beforeAnimation, "after-animation": _ctx.afterAnimation, class: "wizard-step__connector" }, {
    default: withCtx(() => [createVNode(_component_f_validation_form, { id: _ctx.formId, "before-submit": _ctx.beforeNext, "before-validation": _ctx.beforeValidation, "use-error-list": _ctx.useErrorList, class: "wizard-step-body", onSubmit: _ctx.onSubmit }, {
      "error-message": withCtx(() => [renderSlot(_ctx.$slots, "error-message", {}, () => [createTextVNode(
        toDisplayString(_ctx.$t("fkui.wizard-step.errorlist.title", "Oj, du har gl\xF6mt att fylla i n\xE5got. G\xE5 till:")),
        1
        /* TEXT */
      )])]),
      default: withCtx(() => [renderSlot(_ctx.$slots, "default"), createTextVNode(), createElementVNode("div", _hoisted_13, [createElementVNode("button", { "data-test": "submit-button", "data-disabled": _ctx.ignoreClick ? "true" : "false", type: "submit", class: "button button--primary button-group__item button--large" }, [renderSlot(_ctx.$slots, "next-button-text", {}, () => [_ctx.isFinalStep ? (openBlock(), createElementBlock(
        Fragment,
        { key: 0 },
        [createTextVNode(
          toDisplayString(_ctx.$t("fkui.wizard-step.button.next.text-final", "G\xE5 vidare och granska")),
          1
          /* TEXT */
        )],
        64
        ...
        { key: 1 },
        [createTextVNode(
          toDisplayString(_ctx.$t("fkui.wizard-step.button.next.text", "Forts\xE4tt")) + " ",
          1
          /* TEXT */
        ), createElementVNode(
          "span",
          _hoisted_15,
          "\n                                        \xA0" + toDisplayString(_ctx.$t("fkui.wizard-step.button.next.sr-text", "till n\xE4sta steg")),
          1
          /* TEXT */
        )],
        64
        /* STABLE_FRAGMENT */
      ))])], 8, _hoisted_14), createTextVNode(), createElementVNode(
        "button",
        ...
        toDisplayString(_ctx.$t("fkui.wizard-step.button.cancel.text", "Avbryt")),
        1
        /* TEXT */
      )])]),
      _: 3
...
var _sfc_main = defineComponent({ name: "FDialogueTree", components: { FIcon }, props: {
  /**
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1, [_ctx.options.length > 0 ? (openBlock(), createElementBlock("ul", _hoisted_2, [(openBlock(true), createElementBlock(
    Fragment,
    null,
    renderList(_ctx.options, (option, index) => {
      return openBlock(), createElementBlock("li", { key: option.label, class: "dialogue-tree__list-item" }, [createElementVNode("button", { ref_for: true, ref: `dialogueButton-${index}`, type: "button", onClick: ($event) => _ctx.onClickedOption(option, index) }, [createElementVNode(
        "span",
        null,
        toDisplayString(option.label),
        1
        /* TEXT */
      ), createTextVNode(), createVNode(_component_f_icon, { name: "arrow-right" })], 8, _hoisted_3)]);
    }),
    128
    /* KEYED_FRAGMENT */
  ))])) : renderSlot(_ctx.$slots, "default", normalizeProps(mergeProps({ key: 1 }, { userData: _ctx.userData })))]);
}
