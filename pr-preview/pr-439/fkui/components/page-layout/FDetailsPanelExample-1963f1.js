...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-1963f1.js
...
exampleComponent.__scopeId = "data-v-1963f1";
setup({
  rootComponent: exampleComponent,
  selector: "#example-1963f1"
});
export {
  render
};
