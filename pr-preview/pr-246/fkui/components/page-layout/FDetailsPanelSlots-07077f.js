...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-07077f.js
...
exampleComponent.__scopeId = "data-v-07077f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-07077f"
});
export {
  render
};
