...
describe("options API", () => {
    ...
    it("should handle v-model using @model without emit", async () => {
        expect.assertions(3);
        const filepath = fixture("options-vmodel-atmodel.vue");
        const result = await translateAPI(filepath);
    ...
    it("should handle v-model using @model with emit", async () => {
        expect.assertions(3);
        const filepath = fixture("options-vmodel-atmodel-emit.vue");
        const result = await translateAPI(filepath);
        expect(result.models).toEqual([
            {
                name: "v-model",
